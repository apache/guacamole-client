...
/**
 * Unit test for GuacamoleProtocolVersion. Verifies that Guacamole protocol version string parsing
 * works as required.
 */
public class GuacamoleProtocolVersionTest {
  ...
  /**
   * Verifies that the atLeast() function defined by GuacamoleProtocolVersion behaves as required
   * for a series of three versions which are in strictly increasing order (a &lt; b &lt; c).
   *
   * @param a The String representation of the version which is known to be the smaller than
   *          versions b and c.
   * @param b The String representation of the version which is known to be larger than version a
   *          but smaller than version c.
   * @param c The String representation of the version which is known to be the larger than versions
   *          a and b.
   */
  ...
  /**
   * Verifies that version order comparisons using atLeast() behave as required.
   */
  @Test
  ...
  /**
   * Verifies that versions can be converted to their Guacamole protocol representation through
   * calling toString().
   */
  @Test
  public void testToString() {
    ...
    Assert.assertEquals("VERSION_12_103_398",
        new GuacamoleProtocolVersion(12, 103, 398).toString());
  }
