...
/**
 * Unit test for GuacamoleStatus that verifies exception translation functions as required.
 */
public class GuacamoleStatusTest {

  /**
   * Verifies that the {@link SUCCESS} status code does NOT translate to a GuacamoleException, but
  ...
  /**
   * Verifies that each non-success GuacamoleStatus maps to a GuacamoleException associated with
   * that GuacamoleStatus.
   */
  @Test
