...
/**
 * Base GuacamoleTunnel implementation which synchronizes access to the underlying reader and writer
 * with reentrant locks. Implementations need only provide the tunnel's UUID and socket.
 */
public abstract class AbstractGuacamoleTunnel implements GuacamoleTunnel {
   ...
   * associated with the underlying GuacamoleSocket.
   */
