...
public class InetGuacamoleSocket implements GuacamoleSocket {
  ...
  /**
   * Creates a new InetGuacamoleSocket which reads and writes instructions to the Guacamole
   * instruction stream of the Guacamole proxy server running at the given hostname and port.
   *
