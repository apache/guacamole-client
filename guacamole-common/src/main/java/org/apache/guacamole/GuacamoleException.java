...
public class GuacamoleException extends Exception {
  ...
  /**
   * Returns the Guacamole status associated with this exception. This status can then be easily
   * translated into an HTTP error code or Guacamole protocol error code.
   *
   ...
   *
   * @return An integer representing the most applicable HTTP status code associated with this
   * exception.
   */
   ...
   *
   * @return An integer representing the most applicable WebSocket status code associated with this
   * exception.
   */
