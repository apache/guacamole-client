...
public interface GuacamoleWriter {
  ...
  /**
   * Writes a portion of the given array of characters to the Guacamole instruction stream. The
   * portion must contain only complete Guacamole instructions.
   *
   ...
   * @throws GuacamoleException If an error occurred while writing the portion of the array
   *                            specified.
   */
  public void write(char[] chunk, int off, int len) throws GuacamoleException;

  /**
   * Writes the entire given array of characters to the Guacamole instruction stream. The array must
   * consist only of complete Guacamole instructions.
   *
   * @param chunk An array of characters consisting only of complete Guacamole instructions.
   * @throws GuacamoleException If an error occurred while writing the the specified array.
   */
   ...
   * @throws GuacamoleException If an error occurred while writing the instruction.
   */
