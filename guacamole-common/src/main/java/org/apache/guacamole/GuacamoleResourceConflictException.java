...
/**
 * An exception which is thrown when a resource has been requested, but that resource is locked or
 * currently in use, and cannot be accessed by the current user.
 */
