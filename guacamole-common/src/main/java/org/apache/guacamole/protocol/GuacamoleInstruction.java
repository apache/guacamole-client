...
public class GuacamoleInstruction {
  ...
  /**
   * The cached result of converting this GuacamoleInstruction to the format used by the Guacamole
   * protocol.
   */
   ...
   * @param args   The list of argument values to provide in the new instruction if any.
   */
  ...
  /**
   * Creates a new GuacamoleInstruction having the given Operation and list of arguments values. The
   * list given will be used to back the internal list of arguments and the list returned by
   * getArgs().
   *
   * @param opcode The opcode of the instruction to create.
   * @param args   The list of argument values to provide in the new instruction if any.
  ...
  /**
   * Returns a List of all argument values specified for this GuacamoleInstruction. Note that the
   * List returned is immutable. Attempts to modify the list will result in exceptions.
   *
   * @return A List of all argument values specified for this GuacamoleInstruction.
   */
   ...
   *
   * @return This GuacamoleInstruction in the form it would be sent over the Guacamole protocol.
   */
  @Override
