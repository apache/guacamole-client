...
/**
 * A generic exception thrown when part of the Guacamole API encounters an error in the client's
 * request. Such an error, if correctable, usually requires correction on the client side, not the
 * server.
 */
