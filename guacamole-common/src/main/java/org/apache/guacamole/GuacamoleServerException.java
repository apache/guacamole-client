...
/**
 * A generic exception thrown when part of the Guacamole API encounters an unexpected, internal
 * error. An internal error, if correctable, would require correction on the server side, not the
 * client.
 */
