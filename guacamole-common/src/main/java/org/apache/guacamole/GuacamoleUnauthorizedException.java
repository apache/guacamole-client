...
/**
 * A security-related exception thrown when parts of the Guacamole API is denying access to a
 * resource, but access MAY be granted were the user authorized (logged in).
 */
