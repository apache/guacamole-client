...
Guacamole.HTTPTunnel = function (tunnelURL, crossDomain, extraTunnelHeaders) {
  ...
  function reset_timeout() {
    ...
    receive_timeout = window.setTimeout(function () {
      close_tunnel(new Guacamole.Status(Guacamole.Status.Code.UPSTREAM_TIMEOUT,
          "Server timeout."));
  ...
  function sendPendingMessages() {
    ...
    if (outputMessageBuffer.length > 0) {
      ...
      message_xmlhttprequest.setRequestHeader(TUNNEL_TOKEN_HEADER,
          tunnelSessionToken);
  ...
  this.connect = function (data) {
    ...
    connect_xmlhttprequest.onreadystatechange = function () {
      ...
      tunnelSessionToken = connect_xmlhttprequest.getResponseHeader(
          TUNNEL_TOKEN_HEADER);
  ...
  this.disconnect = function () {
    close_tunnel(new Guacamole.Status(Guacamole.Status.Code.SUCCESS,
        "Manually closed."));
  };
    ...
    socket.onmessage = function (event) {
      ...
      do {
        ...
        // If no period, incomplete instruction.
          ...
          close_tunnel(new Guacamole.Status(Guacamole.Status.Code.SERVER_ERROR,
...
Guacamole.ChainedTunnel = function (tunnelChain) {
  ...
  this.connect = function (data) {
    ...
    if (next_tunnel) {
      ...
      chained_tunnel.onerror(Guacamole.Status.Code.SERVER_ERROR,
          "No tunnels to try.");
    }
