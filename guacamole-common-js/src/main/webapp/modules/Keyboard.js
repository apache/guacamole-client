...
Guacamole.Keyboard = function Keyboard(element) {
    ...
    /**
     * Updates keyboard modifier state from a mouse event to resolve deferred
     * Meta key events. When a Meta key is pressed, it is deferred to determine
     * if it's being used as a modifier or as a standalone key. A mouse click
     * with Meta held provides the context needed to resolve this, enabling
     * Cmd+Click functionality.
     *
     * @param {Guacamole.Mouse.Event} mouseEvent
     *     The mouse event that occurred.
     */
    this.updateModifiersFromMouse = function(mouseEvent) {
...
/**
 * Returns the modifier state applicable to the event given. Both KeyboardEvent
 * and MouseEvent are supported.
 *
 * @private
 * @param {!KeyboardEvent|!MouseEvent} e
 *     The keyboard or mouse event to read.
 *
