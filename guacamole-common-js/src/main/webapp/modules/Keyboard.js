...
Guacamole.Keyboard = function Keyboard(element) {
  ...
  var KeyEvent = function KeyEvent(orig) {
     ...
     */
    this.modifiers = orig ? Guacamole.Keyboard.ModifierState.fromKeyboardEvent(
        orig) : new Guacamole.Keyboard.ModifierState();
   ...
   */
  var key_identifier_sane = function key_identifier_sane(keyCode,
      keyIdentifier) {
    ...
    var codepoint = parseInt(keyIdentifier.substring(unicodePrefixLocation + 2),
        16);
