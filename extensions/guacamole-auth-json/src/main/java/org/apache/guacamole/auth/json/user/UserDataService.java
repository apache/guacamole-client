...
public class UserDataService {
  ...
  /**
   * The name of the HTTP parameter from which base64-encoded, encrypted JSON data should be read.
   * The value of this parameter, when decoded and decrypted, must be valid JSON prepended with the
   * 32-byte raw binary signature generated through signing the JSON with the secret key using
   * HMAC/SHA-256.
   */
  ...
  /**
   * Derives a new UserData object from the data contained within the given Credentials. If no such
   * data is present, or the data present is invalid, null is returned.
   *
   * @param credentials The Credentials from which the new UserData object should be derived.
   * @return A new UserData object derived from the data contained within the given Credentials, or
   * null if no such data is present or if the data present is invalid.
   */
  public UserData fromCredentials(Credentials credentials) {
    ...
    try {
      ...
      byte[] receivedJSON = Arrays.copyOfRange(decrypted, CryptoService.SIGNATURE_LENGTH,
          decrypted.length);
  ...
  /**
   * Returns the identifiers of all users readable by the user whose data is given by the provided
   * UserData object. As users of the JSONAuthenticationProvider can only see themselves, this will
   * always simply be a set of the user's own username.
   *
   * @param userData All data associated with the user whose accessible user identifiers are being
   *                 retrieved.
   * @return A set containing the identifiers of all users readable by the user whose data is given
   * by the provided UserData object.
   */
  ...
  /**
   * Returns the user object of the user to whom the given UserData object belongs.
   *
   * @param userData All data associated with the user whose own user object is being retrieved.
   * @return The user object of the user to whom the given UserData object belongs.
   */
  ...
  /**
   * Returns the identifiers of all connections readable by the user whose data is given by the
   * provided UserData object. If the provided UserData is not expired, this will be the set of all
   * connection identifiers within the UserData. If the UserData is expired, this will be an empty
   * set.
   *
   * @param userData All data associated with the user whose accessible connection identifiers are
   *                 being retrieved.
   * @return A set containing the identifiers of all connections readable by the user whose data is
   * given by the provided UserData object.
   */
  ...
  /**
   * Returns a Directory containing all connections accessible by the user whose data is given by
   * the provided UserData object. If the given UserData object is not expired, this Directory will
   * contain absolutely all connections defined within the given UserData. If the given UserData
   * object is expired, this Directory will be empty.
   *
   * @param userData All data associated with the user whose connection directory is being
   *                 retrieved.
   * @return A Directory containing all connections accessible by the user whose data is given by
  ...
  /**
   * Returns the identifiers of all connection groups readable by the user whose data is given by
   * the provided UserData object. This will always be a set containing only the root connection
   * group identifier. The JSONAuthenticationProvider does not define any other connection groups.
   *
   * @param userData All data associated with the user whose accessible connection group identifiers
   *                 are being retrieved.
   * @return A set containing the identifiers of all connection groups readable by the user whose
