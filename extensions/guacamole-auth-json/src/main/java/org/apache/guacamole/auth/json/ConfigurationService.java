...
/**
 * Service for retrieving configuration information regarding the JSON authentication provider.
 */
public class ConfigurationService {
  ...
  /**
   * A comma-separated list of all IP addresses or CIDR subnets which should be allowed to perform
   * authentication. If not specified, ALL address will be allowed.
   */
  ...
  /**
   * Returns the symmetric key which will be used to encrypt and sign all JSON data and should be
   * used to decrypt and verify any received JSON data. This is dictated by the "json-secret-key"
   * property specified within guacamole.properties.
   *
  ...
  /**
   * Returns a collection of all IP address or CIDR subnets which should be allowed to submit
   * authentication requests. If empty, authentication attempts will be allowed through without
   * restriction.
   *
   * @return A collection of all IP address or CIDR subnets which should be allowed to submit
