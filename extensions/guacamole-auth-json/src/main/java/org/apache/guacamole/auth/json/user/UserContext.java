...
/**
 * An implementation of UserContext specific to the JSONAuthenticationProvider which obtains all
 * data from the encrypted JSON provided during authentication.
 */
public class UserContext extends AbstractUserContext {
  ...
  /**
   * The UserData object associated with the user to whom this UserContext belongs.
   */
  private UserData userData;

  /**
   * Initializes this UserContext using the data associated with the provided UserData object.
   *
   * @param userData The UserData object derived from the JSON data received when the user
   *                 authenticated.
   */
