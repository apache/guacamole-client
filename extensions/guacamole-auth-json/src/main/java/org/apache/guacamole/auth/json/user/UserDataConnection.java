...
/**
 * Connection implementation which automatically manages related UserData if the connection is used.
 * Connections which are marked as single-use will be removed from the given UserData such that only
 * the first connection attempt can succeed.
 */
public class UserDataConnection implements Connection {
  ...
  /**
   * A human-readable value which both uniquely identifies this connection and serves as the
   * connection display name.
   */
  private String identifier;

  /**
   * The UserData associated with this connection. This UserData will be automatically updated as
  ...
  /**
   * Initializes this UserDataConnection with the given data, unique identifier, and connection
   * information. This function MUST be invoked before any particular UserDataConnection is actually
   * used.
   *
   * @param data       The UserData that this connection should manage.
   * @param identifier The identifier associated with this connection within the given UserData.
   * @param connection The connection data associated with this connection within the given
   *                   UserData.
   * @return A reference to this UserDataConnection.
   */
