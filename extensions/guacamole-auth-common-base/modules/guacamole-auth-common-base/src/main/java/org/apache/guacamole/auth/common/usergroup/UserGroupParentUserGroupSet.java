 ...
 * between a particular user group and its containing user groups.
 */
public class UserGroupParentUserGroupSet
        extends RelatedObjectSet<ModeledUserGroup, UserGroupModelInterface> {

    /**
     * Mapper for the relation between user groups and their containing user
     * groups.
     */
    private ObjectRelationMapperInterface<UserGroupModelInterface> userGroupParentUserGroupMapper;

    @Inject
    public UserGroupParentUserGroupSet(
            Map<String, ObjectRelationMapperInterface<UserGroupModelInterface>> mappers) {
        userGroupParentUserGroupMapper = mappers
                .get("UserGroupParentUserGroupMapper");
    }
