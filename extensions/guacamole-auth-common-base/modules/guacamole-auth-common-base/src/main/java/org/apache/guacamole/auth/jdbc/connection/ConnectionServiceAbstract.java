...
import org.apache.guacamole.auth.jdbc.base.ModeledChildDirectoryObjectServiceAbstract;
 ...
 */
public abstract class ConnectionServiceAbstract extends
        ModeledChildDirectoryObjectServiceAbstract<ModeledConnection, Connection, ConnectionModelInterface> {
     ...
     */
    @Inject
    private ConnectionParameterMapperInterface parameterMapper;

    /**
     * Mapper for accessing connection history.
     */
    @Inject
    private ConnectionRecordMapperInterface connectionRecordMapper;
    ...
    protected void beforeCreate(ModeledAuthenticatedUser user,
            Connection object, ConnectionModelInterface model)
            throws GuacamoleException {
        ...
        ConnectionModelInterface existing = connectionMapper
    ...
    protected void beforeUpdate(ModeledAuthenticatedUser user,
            ModeledConnection object, ConnectionModelInterface model)
            throws GuacamoleException {
     ...
     */
    protected abstract Collection<ConnectionParameterModelInterface> getParameterModels(
    ...
    public ModeledConnection createObject(ModeledAuthenticatedUser user,
        ...
        Collection<ConnectionParameterModelInterface> parameterModels = getParameterModels(
                connection);
    ...
    public Map<String, String> retrieveParameters(ModeledAuthenticatedUser user,
        ...
        if (canRetrieveParameters) {
            for (ConnectionParameterModelInterface parameter : parameterMapper
                    .select(identifier))
    ...
    public List<ConnectionRecord> retrieveHistory(ModeledAuthenticatedUser user,
        ...
        if (hasObjectPermission(user, identifier, ObjectPermission.Type.READ)) {
            ...
            // Retrieve history
            List<ConnectionRecordModelInterface> models = connectionRecordMapper
                    .select(identifier);
    ...
    public List<ConnectionRecord> retrieveHistory(ModeledAuthenticatedUser user,
        ...
        List<ConnectionRecordModelInterface> searchResults;
