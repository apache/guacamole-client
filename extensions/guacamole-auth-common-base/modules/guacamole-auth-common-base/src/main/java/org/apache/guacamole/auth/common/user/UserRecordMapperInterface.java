 ...
 */
public interface UserRecordMapperInterface {
     ...
     *         such user exists.
     */
    List<ActivityRecordModelInterface> select(String username);
     ...
     */
    int insert(ActivityRecordModelInterface record);
     ...
     */
    int update(ActivityRecordModelInterface record);
