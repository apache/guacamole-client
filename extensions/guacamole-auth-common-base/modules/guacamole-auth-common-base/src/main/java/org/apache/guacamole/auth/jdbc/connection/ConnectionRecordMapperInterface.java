 ...
 */
public interface ConnectionRecordMapperInterface {
     ...
     */
    List<ConnectionRecordModelInterface> select(String identifier);
     ...
     */
    int insert(ConnectionRecordModelInterface record);
     ...
     */
    List<ConnectionRecordModelInterface> search(
     ...
     * @return The results of the search performed with the given parameters.
     */
    List<ConnectionRecordModelInterface> searchReadable(UserModelInterface user,
            Collection<ActivityRecordSearchTerm> terms,
            List<ActivityRecordSortPredicate> sortPredicates, int limit,
