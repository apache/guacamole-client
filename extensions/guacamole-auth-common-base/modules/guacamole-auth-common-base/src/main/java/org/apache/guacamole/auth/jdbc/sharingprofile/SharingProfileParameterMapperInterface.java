 ...
 */
public interface SharingProfileParameterMapperInterface {
     ...
     */
    Collection<SharingProfileParameterModelInterface> select(String identifier);
     ...
     */
    int insert(Collection<SharingProfileParameterModelInterface> parameters);
