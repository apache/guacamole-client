 ...
 */
public interface ConnectionParameterMapperInterface {
     ...
     */
    Collection<ConnectionParameterModelInterface> select(String identifier);
     ...
     */
    int insert(Collection<ConnectionParameterModelInterface> parameters);
