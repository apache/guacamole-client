...
import org.apache.guacamole.auth.jdbc.user.ModeledUserAbstract;
...
public class PasswordPolicyService {
     ...
     */
    @Inject
    private PasswordRecordMapperInterface passwordRecordMapper;
    ...
    private long getPasswordAge(ModeledUserAbstract user) {
        ...
        PasswordRecordModelInterface passwordRecord = user.getPasswordRecord();
