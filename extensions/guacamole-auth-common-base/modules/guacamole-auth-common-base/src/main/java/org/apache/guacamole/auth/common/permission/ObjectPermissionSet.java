 ...
 * a particular user.
 */
public abstract class ObjectPermissionSet extends RestrictedObject implements
     ...
     */
    private ModeledPermissions<? extends EntityModelInterface> entity;
    ...
    /**
     * Creates a new ObjectPermissionSet. The resulting permission set must
     * still be initialized by a call to init(), or the information necessary to
     * read and modify this set will be missing.
     */
    public ObjectPermissionSet() {
    }

    /**
     * Initializes this permission set with the current user and the entity to
     * whom the permissions in this set are granted.
     *
     * @param currentUser
     *            The user who queried this permission set, and whose
     ...
     *
     * @return An object permission service for manipulating the type of
    ...
    public Set<ObjectPermission> getPermissions() throws GuacamoleException {
        return getObjectPermissionService()
                .retrievePermissions(getCurrentUser(), entity, effectiveGroups);
    }

    @Override
    public boolean hasPermission(ObjectPermission.Type permission,
            String identifier) throws GuacamoleException {
        return getObjectPermissionService().hasPermission(getCurrentUser(),
                entity, permission, identifier, effectiveGroups);
    }

    @Override
    public void addPermission(ObjectPermission.Type permission,
            String identifier) throws GuacamoleException {
        addPermissions(Collections
    ...
    public Collection<String> getAccessibleObjects(
        ...
        return getObjectPermissionService().retrieveAccessibleIdentifiers(
                getCurrentUser(), entity, permissions, identifiers,
                effectiveGroups);
    }
    ...
    public void addPermissions(Set<ObjectPermission> permissions)
        ...
        getObjectPermissionService().createPermissions(getCurrentUser(), entity,
                permissions);
    }
    ...
    public void removePermissions(Set<ObjectPermission> permissions)
            throws GuacamoleException {
        getObjectPermissionService().deletePermissions(getCurrentUser(), entity,
                permissions);
    }
