...
public class ConfigurationService {
    ...
    /**
     * The default maximum amount of time that a pkce verifier generated by the
     * Guacamole server should remain valid, in minutes.
     */
    private static final int DEFAULT_MAX_PKCE_VERIFIER_VALIDITY = 10;
    ...
    /**
     * The maximum amount of time that a PKCE verifier generated by the
     * Guacamole server should remain valid, in minutes. As each OpenID request
     * requiring PKCE has a unique verifier, this imposes an upper limit on the
     * amount of time any particular OpenID request can result in successful
     * authentication within Guacamole. By default, each generated PKCE verifier
     * expires after 10 minutes.
     */
    private static final IntegerGuacamoleProperty OPENID_MAX_PKCE_VERIFIER_VALIDITY =
            new IntegerGuacamoleProperty() {

        @Override
        public String getName() { return "openid-max-pkce-verifier-validity"; }
    ...
    /**
     * Returns the maximum amount of time that a PKCE verifier generated by the
     * Guacamole server should remain valid, in minutes. As each OpenID request
     * requiring PKCE has a unique verifier, this imposes an upper limit on the
     * amount of time any particular OpenID request can result in successful
     ...
     *     If guacamole.properties cannot be parsed.
     */
    public int getMaxPKCEVerifierValidity() throws GuacamoleException {
        return environment.getProperty(OPENID_MAX_PKCE_VERIFIER_VALIDITY, DEFAULT_MAX_PKCE_VERIFIER_VALIDITY);
    }
