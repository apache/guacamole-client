...
/**
 * Service for retrieving configuration information regarding the SAML authentication module.
 */
public class ConfigurationService {

  /**
   * The URI of the file containing the XML Metadata associated with the SAML IdP.
   */
  ...
  /**
   * The callback URL to use for SAML IdP, normally the base of the Guacamole install. The SAML
   * extensions callback endpoint will be appended to this value.
   */
  ...
  /**
   * Whether or not debugging should be enabled in the SAML library to help track down errors.
   */
  ...
  /**
   * The property that defines what attribute the SAML provider will return that contains group
  ...
  /**
   * The maximum amount of time to allow for an in-progress SAML authentication attempt to be
   * completed, in minutes. A user that takes longer than this amount of time to complete
   * authentication with their identity provider will be redirected back to the identity provider to
   * try again.
   */
  ...
  /**
   * Returns the URL to be submitted as the client ID to the SAML IdP, as configured in
   * guacamole.properties.
   *
   * @return The URL to send to the SAML IdP as the Client Identifier.
  ...
  /**
   * The URI that contains the metadata that the SAML client should use to communicate with the SAML
   * IdP. This can either be a remote URL of a server that provides this, or can be a URI to a file
   * on the local filesystem. The metadata file is usually generated by the SAML IdP and should be
   * uploaded to the system where the Guacamole client is running.
   *
   * @return The URI of the file containing the metadata used by the SAML client when it
   * communicates with the SAML IdP.
   * @throws GuacamoleException If guacamole.properties cannot be parsed, or if the client metadata
   *                            is missing.
   */
  ...
  /**
   * The callback URL used for the SAML IdP to POST a response to upon completion of authentication,
   * normally the base of the Guacamole install.
   *
   * @return The callback URL to be sent to the SAML IdP that will be POSTed to upon completion of
   * SAML authentication.
   * @throws GuacamoleException If guacamole.properties cannot be parsed, or the property is
   *                            missing.
   */
  ...
  /**
   * Return the Boolean value that indicates whether SAML client debugging will be enabled, as
   * configured in guacamole.properties. The default is false, and debug information will not be
   * generated or logged.
   *
   * @return True if debugging should be enabled in the SAML library, otherwise false.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Return the Boolean value that indicates whether or not compression of SAML requests to the IdP
   * should be enabled or not, as configured in guacamole.properties. The default is to enable
   * compression.
   *
   * @return True if compression should be enabled when sending the SAML request, otherwise false.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Return a Boolean value that indicates whether or not the SAML login should enforce strict
   * security controls, as configured in guacamole.properties. By default this is true, and should
   * be set to true in any production environment.
   *
   * @return True if the SAML login should enforce strict security checks, otherwise false.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Return a Boolean value that indicates whether or not compression should be requested from the
   * server when the SAML response is returned, as configured in guacamole.properties. The default
   * is to request that the response be compressed.
   *
   * @return True if compression should be requested from the server for the SAML response.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Return the name of the attribute that will be supplied by the identity provider that contains
   * the groups of which this user is a member.
   *
   * @return The name of the attribute that contains the user groups.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Returns the maximum amount of time to allow for an in-progress SAML authentication attempt to
   * be completed, in minutes. A user that takes longer than this amount of time to complete
   * authentication with their identity provider will be redirected back to the identity provider to
   * try again.
   *
   * @return The maximum amount of time to allow for an in-progress SAML authentication attempt to
   * be completed, in minutes.
   * @throws GuacamoleException If the authentication timeout cannot be parsed.
   */
   ...
   *
   * @return The collection of SAML settings used to initialize the SAML client.
   * @throws GuacamoleException If guacamole.properties cannot be parsed or if required parameters
   *                            are missing.
   */
