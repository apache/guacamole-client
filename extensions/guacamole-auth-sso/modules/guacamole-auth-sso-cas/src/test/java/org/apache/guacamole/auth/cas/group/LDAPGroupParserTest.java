...
/**
 * Test which confirms that the LDAPGroupParser implementation of GroupParser parses CAS groups
 * correctly.
 */
public class LDAPGroupParserTest {
  ...
  /**
   * Creates a new LDAPGroupParserTest that verifies the functionality of LDAPGroupParser.
   *
   * @throws InvalidNameException If the static string LDAP DN of any test instance of LdapName is
  ...
  /**
   * Verifies that LDAPGroupParser correctly parses LDAP-based CAS groups when no restrictions are
   * enforced on LDAP attributes or the base DN.
   */
  @Test
  ...
  /**
   * Verifies that LDAPGroupParser correctly parses LDAP-based CAS groups when restrictions are
   * enforced on LDAP attributes only.
   */
  @Test
  ...
  /**
   * Verifies that LDAPGroupParser correctly parses LDAP-based CAS groups when restrictions are
   * enforced on the LDAP base DN only.
   */
  @Test
  ...
  /**
   * Verifies that LDAPGroupParser correctly parses LDAP-based CAS groups when restrictions are
   * enforced on both LDAP attributes and the base DN.
   */
  @Test
