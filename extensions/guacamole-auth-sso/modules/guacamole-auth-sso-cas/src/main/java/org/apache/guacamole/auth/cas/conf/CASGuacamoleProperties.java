...
/**
 * Provides properties required for use of the CAS authentication provider. These properties will be
 * read from guacamole.properties when the CAS authentication provider is used.
 */
public class CASGuacamoleProperties {
  ...
  public static final URIGuacamoleProperty CAS_AUTHORIZATION_ENDPOINT =
      new URIGuacamoleProperty() {
        ...
        public String getName() {
          return "cas-authorization-endpoint";
        }

      };
  /**
   * The URI that the CAS service should redirect to after the authentication process is complete.
   * This must be the full URL that a user would enter into their browser to access Guacamole.
   */
  public static final URIGuacamoleProperty CAS_REDIRECT_URI =
      new URIGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "cas-redirect-uri";
        }

      };
  /**
   * The location of the private key file used to retrieve the password if CAS is configured to
   * support ClearPass.
   */
  public static final PrivateKeyGuacamoleProperty CAS_CLEARPASS_KEY =
      new PrivateKeyGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "cas-clearpass-key";
        }

      };
  /**
   * The name of the CAS attribute used for group membership, such as "memberOf". This attribute is
   * case sensitive.
   */
  public static final StringGuacamoleProperty CAS_GROUP_ATTRIBUTE =
      new StringGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "cas-group-attribute";
        }

      };
  /**
   * The format used by CAS to represent group names. Possible formats are "plain" (simple text
   * names) or "ldap" (fully-qualified LDAP DNs).
   */
  ...
  public static final StringGuacamoleProperty CAS_GROUP_LDAP_ATTRIBUTE =
      new StringGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "cas-group-ldap-attribute";
        }
