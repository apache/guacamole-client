...
/**
 * This enum represents supported RADIUS authentication protocols for the guacamole-auth-radius
 * extension.
 */
public enum RadiusAuthenticationProtocol {
  ...
  /**
   * The unique name of the JRadius {@link RadiusAuthenticator} that implements this protocol.
   */
  public final String JRADIUS_PROTOCOL_NAME;

  /**
   * Creates a new RadiusAuthenticationProtocol associated with the given JRadius protocol name.
   *
   * @param protocolName The unique name of the JRadius {@link RadiusAuthenticator} that implements
   *                     this protocol.
   */
  ...
  /**
   * Returns a new instance of the JRadius {@link RadiusAuthenticator} that implements this
   * protocol. This function will never return null.
   *
   * @return A new instance of the JRadius {@link RadiusAuthenticator} that implements this
   * protocol.
   * @throws IllegalStateException If a bug within the JRadius library prevents retrieval of the
