...
/**
 * Stores the RADIUS challenge message and expected credentials in a single object.
 */
public class GuacamoleRadiusChallenge {
  ...
  /**
   * The expected credentials that need to be provided to satisfy the RADIUS authentication
   * challenge.
   */
  private final CredentialsInfo expectedCredentials;

  /**
   * Creates a new GuacamoleRadiusChallenge object with the provided challenge message and expected
   * credentials.
   *
   * @param challengeText       The challenge message sent by the RADIUS server.
   * @param expectedCredentials The credentials required to complete the challenge.
   */
