...
/**
 * TOTP-specific User implementation which wraps a User from another extension, hiding and blocking
 * access to the core attributes used by TOTP.
 */
public class TOTPUser extends DelegatingUser {
  ...
  /**
   * The name of the user attribute defines whether the TOTP key has been confirmed by the user, and
   * the user is thus fully enrolled.
   */
  public static final String TOTP_KEY_CONFIRMED_ATTRIBUTE_NAME = "guac-totp-key-confirmed";

  /**
   * The name of the user attribute defines whether the TOTP key has been generated for the user,
   * regardless of whether that key has been confirmed. This attribute is not stored, but is instead
   * exposed dynamically in lieu of exposing the actual TOTP key.
   */
  public static final String TOTP_KEY_SECRET_GENERATED_ATTRIBUTE_NAME = "guac-totp-key-generated";

  /**
   * The string value used by TOTP user attributes to represent the boolean value "true".
   */
  ...
  /**
   * Wraps the given User object, hiding and blocking access to the core attributes used by TOTP.
   *
