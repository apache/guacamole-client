 ...
 * database.
 * 
 * guacamole_connection: { id: string, connection_name: string, parent:
 * ConnectionGroupModel, protocol: string, proxy_port: int, proxy_hostname:
 * string, proxy_encryption_method: EncryptionMethod, max_connections: int,
 * max_connections_per_user: int, connection_weight: int, failover_only: boolean
 * }
 *
 */
@Entity("guacamole_connection")
public class ConnectionModel extends ChildObjectModel {
     ...
     */
    @Embedded(value = "proxy_encryption_method")
    ...
    /** The sharing profile identifiers. */
    ...
    /**
     * Gets the sharing profile identifiers.
     *
     * @return the sharing profile identifiers
     */
    ...
    /**
     * Sets the sharing profile identifiers.
     *
     * @param sharingProfileIdentifiers
     *            the new sharing profile identifiers
     */
