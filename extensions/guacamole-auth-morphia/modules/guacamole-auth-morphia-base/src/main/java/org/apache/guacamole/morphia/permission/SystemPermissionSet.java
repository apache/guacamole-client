...
public class SystemPermissionSet extends RestrictedObject implements
    ...
    public boolean hasPermission(SystemPermission.Type permission)
        ...
        return systemPermissionService.retrievePermission(getCurrentUser(),
    ...
    public void addPermissions(Set<SystemPermission> permissions)
            throws GuacamoleException {
        systemPermissionService.createPermissions(getCurrentUser(), user,
                permissions);
    }
    ...
    public void removePermissions(Set<SystemPermission> permissions)
            throws GuacamoleException {
        systemPermissionService.deletePermissions(getCurrentUser(), user,
                permissions);
    }
