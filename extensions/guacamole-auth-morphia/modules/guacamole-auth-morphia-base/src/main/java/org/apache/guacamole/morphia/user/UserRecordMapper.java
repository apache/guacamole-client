...
public interface UserRecordMapper {
     ...
     *         such user exists.
     */
    List<ActivityRecordModel> select(String username);
     ...
     */
    int insert(ActivityRecordModel record);
     ...
     */
    int update(ActivityRecordModel record);
     ...
     */
    List<ActivityRecordModel> search(Collection<ActivityRecordSearchTerm> terms,
     ...
     * @return The results of the search performed with the given parameters.
     */
    List<ActivityRecordModel> searchReadable(UserModel user,
