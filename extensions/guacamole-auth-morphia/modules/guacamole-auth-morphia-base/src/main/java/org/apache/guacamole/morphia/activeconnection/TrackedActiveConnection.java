...
package org.apache.guacamole.morphia.activeconnection;
...
import org.apache.guacamole.morphia.tunnel.ActiveConnectionRecord;
 ...
 */
public class TrackedActiveConnection extends RestrictedObject
     ...
     * with the given active connection record. At a minimum, the identifier of
     * this active connection will be set, the start date, and the identifier of
     * the associated connection will be copied. If requested, sensitive
     * information like the associated username will be copied, as well.
     *
     * @param currentUser
     ...
     *            Whether sensitive data should be copied from the connection
    ...
    public void init(ModeledAuthenticatedUser currentUser,
        ...
        this.sharingProfileIdentifier = activeConnectionRecord
