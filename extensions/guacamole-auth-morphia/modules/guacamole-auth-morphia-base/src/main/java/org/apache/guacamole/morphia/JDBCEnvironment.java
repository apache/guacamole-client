...
public abstract class JDBCEnvironment extends LocalEnvironment {
    ...
    public abstract String getMongoDBDatabase();

    public abstract String getMongoDBUsername();

    public abstract String getMongoDBHostname();

    public abstract int getMongoDBPort();

    public abstract String getMongoDBPassword();
