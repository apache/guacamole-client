 ...
 * 
 * guacamole_user: { id: string, username: string, password_hash: string,
 * password_salt: string, password_date: date, disabled: boolean, expired:
 * boolean, access_window_start: , access_window_end: , valid_from: date,
 * valid_until: date, timezone: string, full_name: string, email_address:
 * string, organization: string, organizational_role: string }
 *
 */
@Entity("guacamole_user")
public class UserModel extends ChildObjectModel {
