 ...
 */
public class SystemPermissionService extends
        ModeledPermissionService<SystemPermissionSet, SystemPermission, SystemPermissionModel> {
    ...
    protected SystemPermissionModel getModelInstance(
            final ModeledUser targetUser, final SystemPermission permission) {
    ...
    public void createPermissions(ModeledAuthenticatedUser user,
            ModeledUser targetUser, Collection<SystemPermission> permissions)
    ...
    public void deletePermissions(ModeledAuthenticatedUser user,
        ...
        if (user.getUser().isAdministrator()) {
            ...
            if (user.getUser().getIdentifier()
                    .equals(targetUser.getIdentifier()))
     ...
     *
     * @return The permission of the given type associated with the given user,
     *         or null if no such permission exists.
     *
     * @throws GuacamoleException
    ...
    public SystemPermission retrievePermission(ModeledAuthenticatedUser user,
        ...
        if (canReadPermissions(user, targetUser)) {
            ...
            SystemPermissionModel model = getPermissionMapper()
                    .selectOne(targetUser.getModel(), type);
            if (model == null)
                return null;
