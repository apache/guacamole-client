...
/**
 * guacamole_sharing_profile_attribute: { id: string, attribute_name: string,
 * attribute_value, string, sharing_profile: SharingProfileModel
 * (sharing_profile_id) }.
 */
@Entity("guacamole_sharing_profile_attribute")
public class SharingProfileAttributeModel extends ArbitraryAttributeModel {
