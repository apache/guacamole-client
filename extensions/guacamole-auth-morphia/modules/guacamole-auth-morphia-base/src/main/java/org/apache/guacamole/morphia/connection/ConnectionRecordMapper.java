...
public interface ConnectionRecordMapper {
     ...
     */
    List<ConnectionRecordModel> select(String identifier);
     ...
     */
    int insert(ConnectionRecordModel record);
     ...
     */
    List<ConnectionRecordModel> search(
     ...
     * @return The results of the search performed with the given parameters.
     */
    List<ConnectionRecordModel> searchReadable(UserModel user,
            Collection<ActivityRecordSearchTerm> terms,
            List<ActivityRecordSortPredicate> sortPredicates, int limit);
