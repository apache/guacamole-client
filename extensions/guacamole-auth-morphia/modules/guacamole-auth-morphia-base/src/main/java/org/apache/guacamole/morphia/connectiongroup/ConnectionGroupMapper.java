...
public interface ConnectionGroupMapper
        extends ModeledDirectoryObjectMapper<ConnectionGroupModel> {
     ...
     */
    Set<String> selectReadableIdentifiersWithin(UserModel user,
     ...
     */
    ConnectionGroupModel selectOneByName(String parentIdentifier, String name);
