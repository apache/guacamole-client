...
public abstract class JDBCInjectorProvider {
     ...
     * the entire JDBC authentication extension. This function will generally
     * only be called once, but multiple invocations are possible if get() is
     * invoked several times concurrently prior to the Injector being cached.
     *
     * @return
