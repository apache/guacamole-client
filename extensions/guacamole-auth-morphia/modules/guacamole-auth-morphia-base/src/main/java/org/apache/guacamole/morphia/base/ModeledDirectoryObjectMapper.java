...
public interface ModeledDirectoryObjectMapper<ModelType> {
     ...
     */
    Set<String> selectReadableIdentifiers(UserModel user);
     ...
     */
    Collection<ModelType> select(Collection<String> identifiers);
     ...
     * @return A Collection of all objects having the given identifiers.
     */
    Collection<ModelType> selectReadable(UserModel user,
     ...
     * @return The number of rows deleted.
     */
    int deleteAttributes(ModelType object);
     ...
     * @return The number of rows inserted.
     */
    int insertAttributes(ModelType object);
