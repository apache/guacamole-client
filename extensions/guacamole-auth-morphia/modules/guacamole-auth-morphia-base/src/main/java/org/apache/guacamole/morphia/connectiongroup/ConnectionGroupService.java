...
public class ConnectionGroupService extends
        ModeledChildDirectoryObjectService<ModeledConnectionGroup, ConnectionGroup, ConnectionGroupModel> {
    ...
    protected ModeledConnectionGroup getObjectInstance(
            ModeledAuthenticatedUser currentUser, ConnectionGroupModel model) {
    ...
    protected void beforeCreate(ModeledAuthenticatedUser user,
        ...
        ConnectionGroupModel existing = connectionGroupMapper
    ...
    protected void beforeUpdate(ModeledAuthenticatedUser user,
        ...
        String relativeParentIdentifier = model.getParent();
    ...
    public GuacamoleTunnel connect(ModeledAuthenticatedUser user,
        ...
        if (hasObjectPermission(user, connectionGroup.getIdentifier(),
            ...
            return tunnelService.getGuacamoleTunnel(user, connectionGroup,
                    info);
    ...
    protected Class<? extends ObjectPermissionModel> getClassPermissionModel() {
        return ConnectionGroupPermissionModel.class;
    }
