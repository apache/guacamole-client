...
public interface ObjectPermissionService
    ...
    /**
     * Retrieves the permission of the given type associated with the given user
     * and object, if it exists. If no such permission exists, null is
     *
     * @param user
     ...
     *         and object, or null if no such permission exists.
     *
     ...
     */
    Collection<String> retrieveAccessibleIdentifiers(
