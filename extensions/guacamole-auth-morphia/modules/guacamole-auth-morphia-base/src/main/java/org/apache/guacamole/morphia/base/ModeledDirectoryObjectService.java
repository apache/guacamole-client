...
import org.apache.guacamole.morphia.permission.PermissionMapper;
...
public abstract class ModeledDirectoryObjectService<InternalType extends ModeledDirectoryObject<ModelType>, ExternalType extends Identifiable, ModelType extends ObjectModel>
     ...
     *         service.
     */
    protected abstract PermissionMapper<ObjectPermissionModel> getPermissionMapper();

    protected abstract Class<? extends ObjectPermissionModel> getClassPermissionModel();
     ...
     * the type of objects handled by this directory object service.
     *
     * @param user
     ...
     *             If permission to read the user's permissions is denied.
     */
    protected abstract ObjectPermissionSet getPermissionSet(
            ModeledAuthenticatedUser user) throws GuacamoleException;
    ...
    protected Collection<ObjectPermissionModel> getImplicitPermissions(
        ...
        Collection<ObjectPermissionModel> implicitPermissions = new ArrayList<ObjectPermissionModel>(
        ...
        for (ObjectPermission.Type permission : IMPLICIT_OBJECT_PERMISSIONS) {
            ...
            ObjectPermissionModel permissionModel;

            try {
                permissionModel = getClassPermissionModel().newInstance();
                permissionModel.setUser(userModel);
