...
public interface PasswordRecordMapper
        extends ModeledDirectoryObjectMapper<UserModel> {
     ...
     *         such user exists.
     */
    List<PasswordRecordModel> select(String username, int maxHistorySize);
     ...
     */
    int insert(PasswordRecordModel record, int maxHistorySize);
