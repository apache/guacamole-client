...
/**
 * LDAPConfiguration implementation that reads its configuration details from guacamole.properties.
 */
public class EnvironmentLDAPConfiguration implements LDAPConfiguration {
  ...
  /**
   * Creates a new EnvironmentLDAPConfiguration that reads its configuration details from
   * guacamole.properties, as exposed by the given Environment.
   *
   * @param environment The Guacamole server environment.
   */
