...
/**
 * LDAPConfiguration implementation that is annotated for deserialization by Jackson.
 */
public class JacksonLDAPConfiguration implements LDAPConfiguration {

  /**
   * The regular expressions that match all users that should be routed to the LDAP server
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_HOSTNAME}. If not set within the
   * YAML, this will be null.
   */
  @JsonProperty("hostname")
  private String hostname;

  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_PORT}. If not set within the YAML,
   * this will be null.
   */
  @JsonProperty("port")
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_USERNAME_ATTRIBUTES}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_USER_BASE_DN}. If not set within the
   * YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_CONFIG_BASE_DN}. If not set within
   * the YAML, this will be null.
   */
  @JsonProperty("config-base-dn")
  private String configBaseDn;

  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_GROUP_BASE_DN}. If not set within the
   * YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_GROUP_NAME_ATTRIBUTES}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_SEARCH_BIND_DN}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_SEARCH_BIND_PASSWORD}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_ENCRYPTION_METHOD}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_MAX_SEARCH_RESULTS}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_DEREFERENCE_ALIASES}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_FOLLOW_REFERRALS}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_MAX_REFERRAL_HOPS}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_USER_SEARCH_FILTER}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_GROUP_SEARCH_FILTER}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_OPERATION_TIMEOUT}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_NETWORK_TIMEOUT}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_USER_ATTRIBUTES}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_MEMBER_ATTRIBUTE}. If not set within
   * the YAML, this will be null.
   */
  ...
  /**
   * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_MEMBER_ATTRIBUTE_TYPE}. If not set
   * within the YAML, this will be null.
   */
  ...
  /**
   * Returns the given value, if non-null. If null, the given default value is returned.
   *
   * @param <T>          The type of value accepted and returned.
   * @param value        The possibly null value to return if non-null.
   * @param defaultValue A function which supplies the value to return if the provided value is
   *                     null.
   * @return The provided value, if non-null, otherwise the provided default value.
   * @throws GuacamoleException If an error occurs while producing/retrieving the default value.
   */
  ...
  /**
   * Parses and returns the given value, if non-null. If null, the given default value is returned.
   *
   * @param <T>          The type of value accepted and returned.
   * @param property     The GuacamoleProperty implementation to use to parse the provided String
   *                     value.
   * @param value        The possibly null value to return if non-null.
   * @param defaultValue A function which supplies the value to return if the provided value is
   *                     null.
  ...
  /**
   * Sets the LDAPConfiguration that should be used for the default values of any configuration
   * options omitted from the YAML. If not set, an instance of {@link DefaultLDAPConfiguration} will
   * be used.
   *
   * @param defaultConfig The LDAPConfiguration to use for the default values of any omitted
  ...
  /**
   * Supplier of default values for LDAP configurations. Unlike {@link java.util.function.Supplier},
   * the {@link #get()} function of DefaultSupplier may throw a {@link GuacamoleException}.
   *
   * @param <T> The type of value returned by this DefaultSupplier.
   */
  @FunctionalInterface
  private interface DefaultSupplier<T> {

    /**
     * Returns the value supplied by this DefaultSupplier. The value returned is not cached and may
     * be non-deterministic.
     *
     * @return The value supplied by this DefaultSupplier.
     * @throws GuacamoleException If an error occurs while producing/retrieving the value.
     */
