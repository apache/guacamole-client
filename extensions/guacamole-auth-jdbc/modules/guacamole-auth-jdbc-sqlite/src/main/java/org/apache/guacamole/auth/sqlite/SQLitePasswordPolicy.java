 ...
 * SQLite-specific properties in guacamole.properties.
 */
public class SQLitePasswordPolicy implements PasswordPolicy {
    ...
    private static final IntegerGuacamoleProperty MIN_LENGTH =
        ...
        @Override
        public String getName() { return "sqlite-user-password-min-length"; }
    ...
    private static final IntegerGuacamoleProperty MIN_AGE =
        ...
        @Override
        public String getName() { return "sqlite-user-password-min-age"; }
    ...
    private static final IntegerGuacamoleProperty MAX_AGE =
        ...
        @Override
        public String getName() { return "sqlite-user-password-max-age"; }
    ...
    private static final IntegerGuacamoleProperty HISTORY_SIZE =
        ...
        @Override
        public String getName() { return "sqlite-user-password-history-size"; }
    ...
    private static final BooleanGuacamoleProperty REQUIRE_MULTIPLE_CASE =
        ...
        @Override
        public String getName() { return "sqlite-user-password-require-multiple-case"; }
    ...
    private static final BooleanGuacamoleProperty REQUIRE_DIGIT =
        ...
        @Override
        public String getName() { return "sqlite-user-password-require-digit"; }
    ...
    private static final BooleanGuacamoleProperty REQUIRE_SYMBOL =
        ...
        @Override
        public String getName() { return "sqlite-user-password-require-symbol"; }
    ...
    private static final BooleanGuacamoleProperty PROHIBIT_USERNAME =
        ...
        @Override
        public String getName() { return "sqlite-user-password-prohibit-username"; }
    ...
    /**
     * Creates a new SQLitePasswordPolicy which reads the details of the
     ...
     *     read.
     */
    public SQLitePasswordPolicy(JDBCEnvironment environment) {
