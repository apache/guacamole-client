...
/**
 * PasswordPolicy implementation which reads the details of the policy from MySQL-specific
...
public class MySQLPasswordPolicy implements PasswordPolicy {
  ...
  private static final IntegerGuacamoleProperty MIN_LENGTH =
      new IntegerGuacamoleProperty() {
        ...
        public String getName() {
          return "mysql-user-password-min-length";
        }
  ...
  private static final IntegerGuacamoleProperty MIN_AGE =
      new IntegerGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "mysql-user-password-min-age";
        }
  ...
  private static final IntegerGuacamoleProperty MAX_AGE =
      new IntegerGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "mysql-user-password-max-age";
        }
  ...
  private static final IntegerGuacamoleProperty HISTORY_SIZE =
      new IntegerGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "mysql-user-password-history-size";
        }
  ...
  private static final BooleanGuacamoleProperty REQUIRE_MULTIPLE_CASE =
      new BooleanGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "mysql-user-password-require-multiple-case";
        }
  ...
  private static final BooleanGuacamoleProperty REQUIRE_DIGIT =
      new BooleanGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "mysql-user-password-require-digit";
        }
  ...
  private static final BooleanGuacamoleProperty REQUIRE_SYMBOL =
      new BooleanGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "mysql-user-password-require-symbol";
        }
  ...
  private static final BooleanGuacamoleProperty PROHIBIT_USERNAME =
      new BooleanGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "mysql-user-password-prohibit-username";
        }
  ...
  /**
   * Creates a new MySQLPasswordPolicy which reads the details of the policy from the properties
