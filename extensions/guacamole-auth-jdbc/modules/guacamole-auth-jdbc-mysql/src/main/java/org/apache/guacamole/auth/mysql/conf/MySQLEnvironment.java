...
/**
 * A MySQL-specific implementation of JDBCEnvironment provides database properties specifically for
 * MySQL.
 */
public class MySQLEnvironment extends JDBCEnvironment {
  ...
  /**
   * Constructs a new MySQLEnvironment, providing access to MySQL-specific configuration options.
   *
  ...
  /**
   * Returns the MySQL driver that will be used to talk to the MySQL-compatible database server
   * hosting the Guacamole database. If unspecified, the installed MySQL driver will be
   * automatically detected by inspecting the classes available in the classpath.
   *
   * @return The MySQL driver that will be used to communicate with the MySQL- compatible server.
   * @throws GuacamoleException If guacamole.properties cannot be parsed, or if no MySQL-compatible
  ...
  /**
   * Returns the hostname of the MySQL server hosting the Guacamole authentication tables. If
  ...
  /**
   * Returns the port number of the MySQL server hosting the Guacamole authentication tables. If
   * unspecified, this will be the default MySQL port of 3306.
   *
  ...
  /**
   * Return the MySQL SSL mode as configured in guacamole.properties, or the default value of
   * PREFERRED if not configured.
   *
   * @return The SSL mode to use when connecting to the MySQL server.
   * @throws GuacamoleException If an error occurs retrieving the property value.
   */
  ...
  /**
   * Returns the File where the trusted certificate store is located as configured in
   * guacamole.properties, or null if no value has been configured.  The trusted certificate store
   * is used to validate server certificates when making SSL connections to MySQL servers.
   *
   * @return The File where the trusted certificate store is located, or null if the value has not
   * been configured.
  ...
  /**
   * Returns the password used to access the trusted certificate store as configured in
   * guacamole.properties, or null if no password has been specified.
   *
   * @return The password used to access the trusted certificate store.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Returns the File used to store the client SSL certificate as configured in
   * guacamole.properties, or null if no value has been specified.  This file will be used to load
   * the client certificate used for SSL connections to MySQL servers, if the SSL connection is so
   * configured to require client certificate authentication.
   *
   * @return The File where the client SSL certificate is stored.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Returns the password used to access the client certificate store as configured in
   * guacamole.properties, or null if no value has been specified.
   *
   * @return The password used to access the client SSL certificate store.
   * @throws GuacamoleException If guacamole.properties cannot be parsed.
   */
  ...
  /**
   * Return the server timezone if configured in guacamole.properties, or null if the configuration
   * option is not present.
   *
   * @return The server timezone as configured in guacamole.properties.
   * @throws GuacamoleException If an error occurs retrieving the configuration value.
   */
