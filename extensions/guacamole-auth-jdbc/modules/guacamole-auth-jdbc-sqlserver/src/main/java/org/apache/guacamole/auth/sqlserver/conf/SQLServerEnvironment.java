...
/**
 * A SQLServer-specific implementation of JDBCEnvironment provides database properties specifically
 * for SQLServer.
 */
public class SQLServerEnvironment extends JDBCEnvironment {
  ...
  /**
   * Constructs a new SQLServerEnvironment, providing access to SQLServer-specific configuration
   * options.
   *
  ...
  /**
   * Returns the hostname of the SQLServer server hosting the Guacamole authentication tables. If
  ...
  /**
   * Returns the instance name of the SQL Server installation hosting the Guacamole database, if
   * any.  If unspecified it will be null.
   *
   * @return The instance name of the SQL Server install hosting the Guacamole database, or null if
   * undefined.
   * @throws GuacamoleException If an error occurs reading guacamole.properties.
   */
  ...
  /**
   * Returns the port number of the SQLServer server hosting the Guacamole authentication tables. If
   * unspecified, this will be the default SQLServer port of 5432.
   *
  ...
  /**
   * Returns the name of the SQLServer database containing the Guacamole authentication tables.
   *
