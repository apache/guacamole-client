...
/**
 * Mapper for the one-to-many relationship between a user and the user groups of
 * which it is a member.
 */
public class UserParentUserGroupMapperImp extends
        ObjectRelationMapperImp<UserModelInterface, UserParentUserGroupMapper>
        implements ObjectRelationMapperInterface<UserModelInterface> {
