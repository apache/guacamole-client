...
public interface ConnectionMapper extends ModeledDirectoryObjectMapper<ConnectionModel> {
  ...
  /**
   * Selects the identifiers of all connections within the given parent connection group, regardless
   * of whether they are readable by any particular user. This should only be called on behalf of a
   * system administrator. If identifiers are needed by a non-administrative user who must have
   * explicit read rights, use selectReadableIdentifiersWithin() instead.
   *
  ...
  /**
   * Selects the identifiers of all connections within the given parent connection group that are
   * explicitly readable by the given user. If identifiers are needed by a system administrator
  ...
  /**
   * Selects the connection within the given parent group and having the given name. If no such
   * connection exists, null is returned.
   *
   * @param parentIdentifier The identifier of the parent group to search within.
   * @param name             The name of the connection to find.
   * @return The connection having the given name within the given parent group, or null if no such
   * connection exists.
   */
