...
/**
 * Guice module which configures the injections used by the JDBC authentication provider base. This
 * module MUST be included in the Guice injector, or authentication providers based on JDBC will not
 * function.
 */
public class JDBCAuthenticationProviderModule extends MyBatisModule {
  ...
  /**
   * Creates a new JDBC authentication provider module that configures the various injected base
   * classes using the given environment, and provides connections using the given socket service.
   *
   * @param environment The environment to use to configure injected classes.
   */
