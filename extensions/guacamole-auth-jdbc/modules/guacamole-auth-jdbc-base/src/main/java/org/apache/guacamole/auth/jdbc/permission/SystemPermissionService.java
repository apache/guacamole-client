...
/**
 * Service which provides convenience methods for creating, retrieving, and deleting system
...
public class SystemPermissionService
   ...
   * Permission inheritance through group membership is taken into account.
   *
   ...
   *                        be used.
   * @return true if permission of the given type has been granted to the given entity, false
   * otherwise.
  ...
  public boolean hasPermission(ModeledAuthenticatedUser user,
    ...
    if (canReadPermissions(user, targetEntity)) {
      return getPermissionMapper().selectOne(targetEntity.getModel(), type, effectiveGroups)
          != null;
    }
