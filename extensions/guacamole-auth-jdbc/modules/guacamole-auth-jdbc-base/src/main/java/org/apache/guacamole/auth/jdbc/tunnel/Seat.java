...
public class Seat {
  ...
  /**
   * Creates a new seat which associated the given user with the given connection or connection
   * group.
   *
   * @param username   The username of the user using this seat.
   * @param identifier The identifier of the connection or connection group associated with this
   *                   seat.
   */
