...
/**
 * An implementation of the base Permissions interface which is common to both Users and UserGroups,
...
public abstract class ModeledPermissions<ModelType extends EntityModel>
  ...
  /**
   * Returns whether the underlying entity is a user. Entities may be either users or user groups.
   *
  ...
  /**
   * Returns whether the underlying entity represents a specific user having the given username.
   *
   * @param username The username of a user.
   * @return true if the underlying entity is a user that has the given username, false otherwise.
   */
  ...
  /**
   * Returns whether the underlying entity is a user group. Entities may be either users or user
   * groups.
   *
  ...
  /**
   * Returns whether this entity is effectively unrestricted by permissions, such as a system
   ...
   *
   * @return true if this entity should be unrestricted by permissions, false otherwise.
  ...
  /**
   * Returns the identifiers of all user groups defined within the database which apply to this
   * user, including any groups inherited through membership in yet more groups.
   *
   * @return The identifiers of all user groups defined within the database which apply to this
   * user.
   */
  ...
  /**
   * Returns a Permissions object which represents all permissions granted to this entity, including
   * any permissions inherited through group membership.
   *
   * @return A Permissions object which represents all permissions granted to this entity.
   */
  public Permissions getEffective() {
    ...
    return new Permissions() {
      ...
      public ObjectPermissionSet getActiveConnectionPermissions()
          throws GuacamoleException {
        return activeConnectionPermissionService.getPermissionSet(authenticatedUser,
      ...
      public ObjectPermissionSet getConnectionGroupPermissions()
          throws GuacamoleException {
        return connectionGroupPermissionService.getPermissionSet(authenticatedUser,
            ModeledPermissions.this, effectiveGroups);
      }
      ...
      public ObjectPermissionSet getConnectionPermissions()
          throws GuacamoleException {
        return connectionPermissionService.getPermissionSet(authenticatedUser,
            ModeledPermissions.this, effectiveGroups);
      }
      ...
      public ObjectPermissionSet getSharingProfilePermissions()
          throws GuacamoleException {
        return sharingProfilePermissionService.getPermissionSet(authenticatedUser,
            ModeledPermissions.this, effectiveGroups);
      }
      ...
      public SystemPermissionSet getSystemPermissions()
          throws GuacamoleException {
        return systemPermissionService.getPermissionSet(authenticatedUser, ModeledPermissions.this,
            effectiveGroups);
      }
      ...
      public ObjectPermissionSet getUserPermissions()
          throws GuacamoleException {
        return userPermissionService.getPermissionSet(authenticatedUser, ModeledPermissions.this,
            effectiveGroups);
      }
