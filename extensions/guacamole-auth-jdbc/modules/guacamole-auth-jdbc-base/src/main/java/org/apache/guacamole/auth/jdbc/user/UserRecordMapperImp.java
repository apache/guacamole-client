...
public class UserRecordMapperImp implements UserRecordMapperInterface {
     ...
     */
    public List<ActivityRecordModelInterface> search(
     ...
     * @return The results of the search performed with the given parameters.
     */
    public List<ActivityRecordModelInterface> searchReadable(
            UserModelInterface user, Collection<ActivityRecordSearchTerm> terms,
            List<ActivityRecordSortPredicate> sortPredicates, int limit,
            Collection<String> effectiveGroups) {
        return new ArrayList<ActivityRecordModelInterface>(
                userRecordMapper.searchReadable((UserModel) user, terms,
