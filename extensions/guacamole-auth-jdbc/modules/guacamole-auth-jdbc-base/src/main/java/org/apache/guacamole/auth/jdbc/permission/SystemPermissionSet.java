...
/**
 * A database implementation of SystemPermissionSet which uses an injected service to query and
 * manipulate the system permissions associated with a particular entity.
 */
public class SystemPermissionSet extends RestrictedObject
  ...
  /**
   * Creates a new SystemPermissionSet. The resulting permission set must still be initialized by a
  ...
  public boolean hasPermission(SystemPermission.Type permission)
    ...
    return systemPermissionService.hasPermission(getCurrentUser(), entity, permission,
        effectiveGroups);
  }
