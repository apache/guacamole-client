 ...
 * within directories. This service will automatically enforce the permissions of the current user.
 *
...
public abstract class ModeledDirectoryObjectService<InternalType extends ModeledDirectoryObject<ModelType>,
  ...
  /**
   * All object permissions which are implicitly granted upon creation to the creator of the
   * object.
   */
  ...
  /**
   * Returns an instance of a mapper for the type of object used by this service.
   *
   * @return A mapper which provides access to the model objects associated with the objects used by
   * this service.
   */
  protected abstract ModeledDirectoryObjectMapper<ModelType> getObjectMapper();

  /**
   * Returns an instance of a mapper for the type of permissions that affect the type of object used
   * by this service.
   *
   * @return A mapper which provides access to the model objects associated with the permissions
   * that affect the objects used by this service.
   */
  protected abstract ObjectPermissionMapper getPermissionMapper();

  /**
   * Returns an instance of an object which is backed by the given model object.
   *
   * @param currentUser The user for whom this object is being created.
   * @param model       The model object to use to back the returned object.
   * @return An object which is backed by the given model object.
   * @throws GuacamoleException If the object instance cannot be created.
   */
   ...
   *
   * @param currentUser The user for whom this model object is being created.
   * @param object      The object to use to produce the returned model object.
   * @return A model object which is based on the given object.
   * @throws GuacamoleException If the model object instance cannot be created.
   */
  ...
  /**
   * Returns whether the given user has permission to create the type of objects that this directory
   * object service manages, taking into account permission inheritance through user groups.
   *
   * @param user The user being checked.
   * @return true if the user has object creation permission relevant to this directory object
  ...
  /**
   * Returns whether the given user has permission to perform a certain action on a specific object
   * managed by this directory object service, taking into account permission inheritance through
   * user groups.
   *
   * @param user       The user being checked.
   * @param identifier The identifier of the object to check.
   * @param type       The type of action that will be performed.
   * @return true if the user has object permission relevant described, false otherwise.
   * @throws GuacamoleException If permission to read the user's permissions is denied.
   */
   ...
   * handled by this directory object service, taking into account permission inheritance via user
   * groups.
   *
   ...
   * related to the type of objects handled by this directory object service.
   * @throws GuacamoleException If permission to read the user's permissions is denied.
   */
  ...
  /**
   * Returns a collection of objects which are backed by the models in the given collection.
   *
   * @param currentUser The user for whom these objects are being created.
   * @param models      The model objects to use to back the objects within the returned
   *                    collection.
   * @return A collection of objects which are backed by the models in the given collection.
   * @throws GuacamoleException If any of the object instances cannot be created.
   */
  ...
  /**
   * Called before any object is created through this directory object service. This function serves
   * as a final point of validation before the create operation occurs. In its default
   * implementation, beforeCreate() performs basic permissions checks.
   *
   * @param user   The user creating the object.
   * @param object The object being created.
   * @param model  The model of the object being created.
   * @throws GuacamoleException If the object is invalid, or an error prevents validating the given
   *                            object.
   */
  ...
  /**
   * Called before any object is updated through this directory object service. This function serves
   * as a final point of validation before the update operation occurs. In its default
   * implementation, beforeUpdate() performs basic permissions checks.
   *
   * @param user   The user updating the existing object.
   * @param object The object being updated.
   * @param model  The model of the object being updated.
   * @throws GuacamoleException If the object is invalid, or an error prevents validating the given
   *                            object.
   */
  ...
  /**
   * Called before any object is deleted through this directory object service. This function serves
   * as a final point of validation before the delete operation occurs. In its default
   * implementation, beforeDelete() performs basic permissions checks.
   *
   * @param user       The user deleting the existing object.
   * @param identifier The identifier of the object being deleted.
   * @throws GuacamoleException If the object is invalid, or an error prevents validating the given
   *                            object.
   */
  ...
  /**
   * Returns whether the given string is a valid identifier within the JDBC authentication
   * extension. Invalid identifiers may result in SQL errors from the underlying database when used
   * in queries.
   *
   * @param identifier The string to check for validity.
  ...
  /**
   * Filters the given collection of strings, returning a new collection containing only those
   * strings which are valid identifiers. If no strings within the collection are valid identifiers,
   * the returned collection will simply be empty.
   *
   * @param identifiers The collection of strings to filter.
   * @return A new collection containing only the strings within the provided collection which are
   * valid identifiers.
   */
  ...
  /**
   * Returns an immutable collection of permissions that should be granted due to the creation of
   * the given object. These permissions need not be granted solely to the user creating the
   * object.
   *
   * @param user  The user creating the object.
   * @param model The object being created.
   * @return The collection of implicit permissions that should be granted due to the creation of
   * the given object.
   */
