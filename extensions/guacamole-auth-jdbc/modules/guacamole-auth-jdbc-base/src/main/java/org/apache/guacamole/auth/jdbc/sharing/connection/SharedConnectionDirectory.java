...
/**
 * A Directory implementation which exposes an explicitly-registered set of share keys as
 * connections. Only explicitly-registered share keys are accessible a SharedConnectionDirectory.
 */
public class SharedConnectionDirectory implements Directory<Connection> {

  /**
   * The set of share keys that have been explicitly registered. In general, only valid share keys
   * will be present here, but invalid keys are only removed after an attempt to retrieve those keys
   * has been made.
   */
  ...
  /**
   * Creates a new SharedConnectionDirectory which exposes share keys as connections. Only
   * explicitly-registered and valid share keys will be accessible.
   *
   * @param currentUser The user associated with the UserContext that will contain this directory.
   */
  ...
  /**
   * Registers a new share key such that the connection associated with that share key is accessible
   * through this directory. The share key will be automatically de-registered when it is no longer
   * valid.
   *
