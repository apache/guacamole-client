...
public class SharingProfileParameterModel {
  ...
  /**
   * Returns the identifier of the sharing profile associated with this parameter.
   *
   * @return The identifier of the sharing profile associated with this parameter.
   */
  ...
  /**
   * Sets the identifier of the sharing profile associated with this parameter.
   *
   * @param sharingProfileIdentifier The identifier of the sharing profile to associate with this
   *                                 parameter.
   */
