...
/**
 * The root connection group, here represented as its own dedicated object as the database does not
 * contain an actual root group.
 */
public class RootConnectionGroup extends RestrictedObject
    implements ConnectionGroup {

  /**
   * The identifier used to represent the root connection group. There is no corresponding entry in
   * the database, thus a reserved identifier that cannot collide with database-generated
   * identifiers is needed.
   */
  public static final String IDENTIFIER = "ROOT";

  /**
   * The human-readable name of this connection group. The name of the root group is not normally
   * visible, and may even be replaced by the web interface for the sake of translation.
   */
