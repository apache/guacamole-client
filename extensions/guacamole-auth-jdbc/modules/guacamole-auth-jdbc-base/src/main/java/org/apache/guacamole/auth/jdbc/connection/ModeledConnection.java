...
/**
 * An implementation of the Connection object which is backed by a database model.
 */
public class ModeledConnection extends ModeledChildDirectoryObject<ConnectionModel>
    implements Connection {

  /**
   * The name of the attribute which overrides the hostname used to connect to guacd for this
   * connection.
   */
  public static final String GUACD_HOSTNAME_NAME = "guacd-hostname";
  /**
   * The name of the attribute which overrides the port used to connect to guacd for this
   * connection.
   */
  public static final String GUACD_PORT_NAME = "guacd-port";
  /**
   * The name of the attribute which overrides the encryption method used to connect to guacd for
   * this connection.
   */
  public static final String GUACD_ENCRYPTION_NAME = "guacd-encryption";
  /**
   * The value specified for the "guacd-encryption" attribute if encryption should not be used to
   * connect to guacd.
   */
  public static final String GUACD_ENCRYPTION_VALUE_NONE = "none";
  /**
   * The value specified for the "guacd-encryption" attribute if SSL/TLS encryption should be used
   * to connect to guacd.
   */
  public static final String GUACD_ENCRYPTION_VALUE_SSL = "ssl";
  /**
   * All attributes which describe the configuration of the guacd instance which will be used to
   * connect to the remote desktop described by this connection.
   */
  ...
  /**
   * The name of the attribute which controls whether the connection should be used as a spare only
   * (all other non-spare connections within the same balancing group should be preferred).
   */
  ...
  /**
   * All possible attributes of connection objects organized as individual, logical forms.
   */
  ...
  /**
   * The names of all attributes which are explicitly supported by this extension's Connection
   * objects.
   */
  ...
  public void setAttributes(Map<String, String> attributes) {
    ...
    try {
      getModel().setConnectionWeight(NumericField.parse(attributes.get(CONNECTION_WEIGHT)));
    } catch (NumberFormatException e) {
  ...
  /**
   * Returns the maximum number of connections that should be allowed to this connection overall. If
   * no limit applies, zero is returned.
   *
   * @return The maximum number of connections that should be allowed to this connection overall, or
  ...
  /**
   * Returns the maximum number of connections that should be allowed to this connection for any
   * individual user. If no limit applies, zero is returned.
   *
   * @return The maximum number of connections that should be allowed to this connection for any
   * individual user, or zero if no limit applies.
   * @throws GuacamoleException If an error occurs while parsing the concurrency limit properties
   *                            specified within guacamole.properties.
   */
  ...
  /**
   * Returns the connection information which should be used to connect to guacd when establishing a
   * connection to the remote desktop described by this connection. If no such information is
   * defined for this specific remote desktop connection, the default guacd connection information
   * will be used instead, as defined by JDBCEnvironment.
   *
   * @return The connection information which should be used to connect to guacd when establishing a
   * connection to the remote desktop described by this connection.
   * @throws GuacamoleException If the connection information for guacd cannot be parsed.
   */
  ...
  /**
   * Returns the weight of the connection used in applying weighted load balancing algorithms, or a
   * default of 1 if the attribute is undefined.
   *
   * @return The weight of the connection used in applying weighted load balancing algorithms.
   */
