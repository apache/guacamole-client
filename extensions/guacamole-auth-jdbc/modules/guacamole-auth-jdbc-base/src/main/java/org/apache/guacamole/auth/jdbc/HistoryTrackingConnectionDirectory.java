...
/**
 * A connection directory that returns HistoryTrackingConnection-wrapped connections when queried.
 */
public class HistoryTrackingConnectionDirectory extends DecoratingDirectory<Connection> {
   ...
   * directory will be wrapped in a HistoryTrackingConnection, enabling connection history records
   * to be written with the provided connection record mapper.
   *
   * @param directory              The connection directory to wrap.
   * @param user                   The user associated with the connection directory.
   ...
   */
  public HistoryTrackingConnectionDirectory(Directory<Connection> directory, User user,
      String remoteHost, ConnectionRecordMapper connectionRecordMapper) {
    super(directory);
