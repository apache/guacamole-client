...
/**
 * Tunnel implementation which automatically writes an end date for the provided connection history
 * record model using the provided connection history mapper, when the tunnel is closed.
 */
public class HistoryTrackingTunnel extends DelegatingGuacamoleTunnel {
  ...
  /**
   * Creates a new HistoryTrackingTunnel that wraps the given tunnel, automatically setting the end
   * date for the provided connection history records, using the provided connection history record
   * mapper.
   *
   * @param tunnel                 The tunnel to wrap.
   * @param connectionRecordMapper The mapper to use when writing connection history records.
   * @param connectionRecordModel  The connection history record model representing the in-progress
   *                               connection.
   */
