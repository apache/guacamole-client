...
/**
 * Service which provides convenience methods for creating, retrieving, and deleting connection
 * group permissions. This service will automatically enforce the permissions of the current user.
 */
