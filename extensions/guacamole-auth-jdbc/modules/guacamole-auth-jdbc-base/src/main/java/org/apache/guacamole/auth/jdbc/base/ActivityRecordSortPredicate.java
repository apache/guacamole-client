...
public class ActivityRecordSortPredicate {
  ...
  /**
   * Creates a new ActivityRecordSortPredicate with the given sort property and sort order.
   *
   * @param property   The property to use when sorting ActivityRecords.
   * @param descending Whether the sort order is descending (true) or ascending (false).
   */
