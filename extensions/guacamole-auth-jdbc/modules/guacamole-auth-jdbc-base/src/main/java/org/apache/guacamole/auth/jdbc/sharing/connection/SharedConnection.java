...
/**
 * A Connection which joins an active connection, limited by restrictions defined by a sharing
 * profile.
 */
public class SharedConnection implements Connection {

  /**
   * The name of the attribute which contains the username of the user that shared this connection.
   */
  ...
  /**
   * The user that successfully authenticated to obtain access to this SharedConnection.
   */
  private RemoteAuthenticatedUser user;

  /**
   * The SharedConnectionDefinition dictating the connection being shared and any associated
   * restrictions.
   */
  private SharedConnectionDefinition definition;

  /**
   * Creates a new SharedConnection which can be used to join the connection described by the given
   * SharedConnectionDefinition.
   *
   * @param user       The user that successfully authenticated to obtain access to this
   *                   SharedConnection.
