 ...
 */
public class ConnectionRecordMapperImp implements ConnectionRecordMapperInterface {
     ...
     */
    public List<ConnectionRecordModelInterface> select(String identifier) {
    	return new ArrayList<ConnectionRecordModelInterface>(connectionRecordMapper.select(identifier));
    }
     ...
     */
    public int insert(ConnectionRecordModelInterface record) {
    	return connectionRecordMapper.insert((ConnectionRecordModel) record);
    }
     ...
     */
    public List<ConnectionRecordModelInterface> search(Collection<ActivityRecordSearchTerm> terms,
									            List<ActivityRecordSortPredicate> sortPredicates,
									            int limit) {
    	return new ArrayList<ConnectionRecordModelInterface>(connectionRecordMapper.search(terms, sortPredicates, limit));
    }
     ...
     *     The results of the search performed with the given parameters.
     */
    public List<ConnectionRecordModelInterface> searchReadable(UserModelInterface user,
            Collection<ActivityRecordSearchTerm> terms,
            List<ActivityRecordSortPredicate> sortPredicates,
            int limit,
            Collection<String> effectiveGroups) {
    	return new ArrayList<ConnectionRecordModelInterface>(connectionRecordMapper.searchReadable((UserModel) user, terms, sortPredicates, limit, effectiveGroups));
    }
