 ...
 */
public class ConnectionGroupMapperImp extends ModeledDirectoryObjectMapperImp<ConnectionGroupModel, ConnectionGroupMapper> implements ConnectionGroupMapperInterface {
    ...
    public Set<String> selectReadableIdentifiersWithin(UserModelInterface user,
    	...
    	return connectionGroupMapper.selectReadableIdentifiersWithin((UserModel) user, parentIdentifier, effectiveGroups);
    }
