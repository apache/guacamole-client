...
/**
 * Implementation of GuacamoleSocket which connects via TCP to a given hostname and port. If the
...
public class ManagedInetGuacamoleSocket extends InetGuacamoleSocket {
  ...
  /**
   * Creates a new socket which connects via TCP to a given hostname and port. If the socket is
