...
/**
 * A single password record representing a previous password of a particular user, along with the
 * time/date that password was set.
 */
public class PasswordRecordModel {
  ...
  /**
   * The date and time when this password was first set for the associated user.
   */
  ...
  /**
   * Creates a new PasswordRecordModel associated with the given user and populated with that user's
   * password hash and salt.
   *
   * @param user The user to associate with this PasswordRecordModel.
   */
   ...
   *
   * @param userID The database ID of the user to associate with this password record.
   */
   ...
   *
   * @param passwordHash The hash of the password and password salt.
   */
   ...
   *
   * @param passwordSalt The random salt used when generating the password hash.
   */
  ...
  /**
   * Returns the date that this password was first set for the associated user.
   *
   * @return The date that this password was first set for the associated user.
   */
   ...
   *
   * @param passwordDate The date that this password was first set for the associated user.
   */
