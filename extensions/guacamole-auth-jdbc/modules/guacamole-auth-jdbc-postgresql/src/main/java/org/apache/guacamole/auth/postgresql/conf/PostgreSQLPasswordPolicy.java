...
/**
 * PasswordPolicy implementation which reads the details of the policy from PostgreSQL-specific
...
public class PostgreSQLPasswordPolicy implements PasswordPolicy {
  ...
  /**
   * Creates a new PostgreSQLPasswordPolicy which reads the details of the policy from the
   * properties exposed by the given environment.
   *
