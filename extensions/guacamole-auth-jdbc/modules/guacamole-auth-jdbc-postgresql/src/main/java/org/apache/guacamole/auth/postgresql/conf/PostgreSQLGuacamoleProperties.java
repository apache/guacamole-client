...
public class PostgreSQLGuacamoleProperties {
  ...
  /**
   * The port of the PostgreSQL server hosting the Guacamole authentication tables.
   */
  ...
  /**
   * The name of the PostgreSQL database containing the Guacamole authentication tables.
   */
  ...
  /**
   * The username used to authenticate to the PostgreSQL database containing the Guacamole
  ...
  /**
   * The password used to authenticate to the PostgreSQL database containing the Guacamole
   * authentication tables.
   */
  ...
  /**
   * The number of seconds the driver will wait for a response from the database, before aborting
   * the query. A value of 0 (the default) means the timeout is disabled.
   */
  public static final IntegerGuacamoleProperty
    ...
    @Override
    public String getName() {
      return "postgresql-default-statement-timeout";
    }

  };
  /**
   * The number of seconds to wait for socket read operations. If reading from the server takes
   * longer than this value, the connection will be closed. This can be used to handle network
   * problems such as a dropped connection to the database. Similar to
   * postgresql-default-statement-timeout, it will have the effect of aborting queries that take too
   * long. A value of 0 (the default) means the timeout is disabled.
   */
  public static final IntegerGuacamoleProperty
    ...
    @Override
    public String getName() {
      return "postgresql-socket-timeout";
    }
  ...
  /**
   * The SSL mode that should be used by the JDBC driver when making connections to the remote
   * server.  By default SSL will be attempted but plain-text will be allowed if SSL fails.
   */
  public static final EnumGuacamoleProperty<PostgreSQLSSLMode> POSTGRESQL_SSL_MODE =
      new EnumGuacamoleProperty<PostgreSQLSSLMode>(PostgreSQLSSLMode.class) {
        ...
        @Override
        public String getName() {
          return "postgresql-ssl-mode";
        }

      };
  /**
   * The client SSL certificate file used by the JDBC driver to make the SSL connection.
   */
  public static final FileGuacamoleProperty POSTGRESQL_SSL_CERT_FILE =
      new FileGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "postgresql-ssl-cert-file";
        }

      };
  /**
   * The client SSL private key file used by the JDBC driver to make the SSL connection.
   */
  public static final FileGuacamoleProperty POSTGRESQL_SSL_KEY_FILE =
      new FileGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "postgresql-ssl-key-file";
        }

      };
  /**
   * The client SSL root certificate file used by the JDBC driver to validate certificates when
  ...
  public static final FileGuacamoleProperty POSTGRESQL_SSL_ROOT_CERT_FILE =
      new FileGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "postgresql-ssl-root-cert-file";
        }

      };
  /**
   * The password of the SSL private key used by the JDBC driver to make the SSL connection to the
   * PostgreSQL server.
   */
  public static final StringGuacamoleProperty POSTGRESQL_SSL_KEY_PASSWORD =
      new StringGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "postgresql-ssl-key-password";
        }

      };
  /**
   * Whether or not to automatically create accounts in the PostgreSQL database for users who
  ...
  public static final BooleanGuacamoleProperty POSTGRESQL_AUTO_CREATE_ACCOUNTS =
      new BooleanGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "postgresql-auto-create-accounts";
        }

      };
  /**
   * Whether or not to track connection history for connections that do not originate from within
   * the Postgres database. By default, external connection history will be tracked.
   */
  public static final BooleanGuacamoleProperty POSTGRESQL_TRACK_EXTERNAL_CONNECTION_HISTORY =
      new BooleanGuacamoleProperty() {
        ...
        @Override
        public String getName() {
          return "postgresql-track-external-connection-history";
        }
