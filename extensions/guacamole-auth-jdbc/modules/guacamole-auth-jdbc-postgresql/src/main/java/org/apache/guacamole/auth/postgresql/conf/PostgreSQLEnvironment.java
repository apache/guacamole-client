...
/**
 * A PostgreSQL-specific implementation of JDBCEnvironment provides database properties specifically
 * for PostgreSQL.
 */
public class PostgreSQLEnvironment extends JDBCEnvironment {
  ...
  /**
   * The default number of seconds the driver will wait for a response from the database, before
   * aborting the query. A value of 0 (the default) means the timeout is disabled.
   */
  private static final int DEFAULT_STATEMENT_TIMEOUT = 0;

  /**
   * The default number of seconds to wait for socket read operations. A value of 0 (the default)
   * means the timeout is disabled.
   */
  private static final int DEFAULT_SOCKET_TIMEOUT = 0;

  /**
   * Whether a database user account is required by default for authentication to succeed.
   */
  private static final boolean DEFAULT_USER_REQUIRED = false;

  /**
   * The default value for the maximum number of connections to be allowed to the Guacamole server
   * overall.
   */
  private final int DEFAULT_ABSOLUTE_MAX_CONNECTIONS = 0;

  /**
   * The default value for the default maximum number of connections to be allowed per user to any
   * one connection. Note that, as long as the legacy "disallow duplicate" and "disallow
   * simultaneous" properties are still supported, these cannot be constants, as the legacy
   * properties dictate the values that should be used in the absence of the correct properties.
   */
  private final int DEFAULT_MAX_CONNECTIONS_PER_USER = 1;

  /**
   * The default value for the default maximum number of connections to be allowed per user to any
   * one connection group. Note that, as long as the legacy "disallow duplicate" and "disallow
   * simultaneous" properties are still supported, these cannot be constants, as the legacy
   * properties dictate the values that should be used in the absence of the correct properties.
   */
  ...
  /**
   * The default value for the default maximum number of connections to be allowed to any one
   * connection. Note that, as long as the legacy "disallow duplicate" and "disallow simultaneous"
   * properties are still supported, these cannot be constants, as the legacy properties dictate the
   * values that should be used in the absence of the correct properties.
   */
  private final int DEFAULT_MAX_CONNECTIONS = 0;

  /**
   * The default value for the default maximum number of connections to be allowed to any one
   * connection group. Note that, as long as the legacy "disallow duplicate" and "disallow
   * simultaneous" properties are still supported, these cannot be constants, as the legacy
   * properties dictate the values that should be used in the absence of the correct properties.
   */
  ...
  /**
   * Constructs a new PostgreSQLEnvironment, providing access to PostgreSQL-specific configuration
   * options.
   *
   * @throws GuacamoleException If an error occurs while setting up the underlying JDBCEnvironment
  ...
  /**
   * Returns the hostname of the PostgreSQL server hosting the Guacamole authentication tables. If
   * unspecified, this will be "localhost".
   *
   * @return The URL of the PostgreSQL server.
   * @throws GuacamoleException If an error occurs while retrieving the property value.
   */
  ...
  /**
   * Returns the port number of the PostgreSQL server hosting the Guacamole authentication tables.
   * If unspecified, this will be the default PostgreSQL port of 5432.
   *
  ...
  /**
   * Returns the name of the PostgreSQL database containing the Guacamole authentication tables.
   *
   * @return The name of the PostgreSQL database.
   * @throws GuacamoleException If an error occurs while retrieving the property value, or if the
  ...
  /**
   * Returns the defaultStatementTimeout set for PostgreSQL connections. If unspecified, this will
   * default to 0, and should not be passed through to the backend.
   *
  ...
  /**
   * Returns the socketTimeout property to set on PostgreSQL connections. If unspecified, this will
   * default to 0 (no timeout)
   *
   * @return The socketTimeout to use when waiting on read operations (in seconds)
   * @throws GuacamoleException If an error occurs while retrieving the property value.
   */
  ...
  /**
   * Get the SSL mode to use to make the JDBC connection to the PostgreSQL server.  If unspecified
   * this will default to PREFER, attempting SSL and falling back to plain-text if SSL fails.
   *
   * @return The enum value of the SSL mode to use to make the JDBC connection to the server.
   * @throws GuacamoleException If an error occurs retrieving the value from guacamole.properties.
   */
  ...
  /**
   * Return the SSL client certificate file to use to make the connection to the PostgreSQL server.
   *
   * @return The SSL client certificate file to use for the PostgreSQL connection.
   * @throws GuacamoleException If an error occurs retrieving the value from guacamole.properties.
   */
  ...
  /**
   * Return the SSL client private key file to use to make the connection to the PostgreSQL server.
   *
   * @return The SSL client private key file to use for the PostgreSQL connection.
   * @throws GuacamoleException If an error occurs retrieving the value from guacamole.properties.
   */
  ...
  /**
   * Return the SSL client root certificate file to use to make the connection to the PostgreSQL
   * server.
   *
   * @return The SSL client root certificate file to use to make the connection to the PostgreSQL
   * server.
  ...
  /**
   * Return the password to use to decrypt the private SSL key file when making the connection to
