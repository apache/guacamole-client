...
public class QuickConnectAuthenticationProviderModule extends AbstractModule {
  ...
  /**
   * A reference to the QuickConnectAuthenticationProvider on behalf of which this module has
   * configured injection.
   */
  private final AuthenticationProvider authProvider;

  /**
   * Creates a new QuickConnect authentication provider module which configures injection for the
