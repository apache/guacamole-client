...
/**
 * A simple implementation of UserContext to support this extension, used for storing connections
 * the user has created with the QuickConnect bar in the webapp.
 */
public class QuickConnectUserContext extends AbstractUserContext {
  ...
  /**
   * Reference to the user whose permissions dictate the configurations accessible within this
   * UserContext.
   */
  private User self;
   ...
   *
   * @param username The name of the user logging in that will be associated with this UserContext.
   * @throws GuacamoleException If errors occur initializing the ConnectionGroup,
