...
public class QCParserTest {
  ...
  /**
   * Verify that the getConfiguration() method returns the expected GuacamoleConfiguration object.
   *
   * @throws GuacamoleException If the configuration cannot be parsed from the given URI or Java
  ...
  public void testGetConfiguration() throws GuacamoleException {
    ...
    parser = new QCParser(Arrays.asList("hostname", "username", "password", "port"),
