...
angular.module('prompt').factory('PromptAction', [function definePromptAction() {
    ...
    /**
     * Creates a new PromptAction, which pairs a callback method with
     * an action name. The name of this action will be presented to
     * the user when the user is prompted to fill out parameters.
     *
     * @constructor
