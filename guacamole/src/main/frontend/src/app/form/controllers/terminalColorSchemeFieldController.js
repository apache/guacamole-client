    ...
    ['$scope', '$injector',
      function terminalColorSchemeFieldController($scope, $injector) {
        ...
        $scope.$watch('model', function modelChanged(model) {
          if ($scope.selectedColorScheme === CUSTOM_COLOR_SCHEME || (model
              && !_.includes($scope.field.options, model))) {
        ...
        $scope.$watch('selectedColorScheme',
