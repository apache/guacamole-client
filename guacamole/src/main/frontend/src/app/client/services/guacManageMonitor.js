...
angular.module('client').factory('guacManageMonitor', ['$injector',
    ...
    /**
     * Generates a new, hard-to-guess per-connection channel identifier.
     *
     * @returns {String}
    ...
    service.init = function init(type, id) {
        ...
        // Establish the per-connection channel id (generated by the primary,
        // inherited by secondaries) so only windows of the same connection
        // share a broadcast channel.
