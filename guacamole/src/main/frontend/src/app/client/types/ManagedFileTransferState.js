...
angular.module('client').factory('ManagedFileTransferState',
    [function defineManagedFileTransferState() {
      ...
      var ManagedFileTransferState = function ManagedFileTransferState(template) {
         ...
         */
        this.streamState = template.streamState
            || ManagedFileTransferState.StreamState.IDLE;
       ...
       *     touched.
       */
      ManagedFileTransferState.setStreamState = function setStreamState(transferState,
          streamState, statusCode) {

        // Do not set state after an error is registered
        if (transferState.streamState
