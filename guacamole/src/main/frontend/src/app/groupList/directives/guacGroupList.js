      ...
      return {
        ...
        controller: ['$scope', '$injector',
          function guacGroupListController($scope, $injector) {
             ...
             *     connection.
             */
            var countActiveConnections = function countActiveConnections(dataSource,
                connection) {
                ...
                function setContents(connectionGroups) {
                  ...
                  if (connectionGroups) {
                    ...
                    angular.forEach(connectionGroups,
                        function addConnectionGroup(connectionGroup,
                            dataSource) {
                          ...
                          if ($scope.showRootGroup) {
                            ...
                            angular.forEach(rootItem.children,
                    ...
                    .then(
                        function activeConnectionsRetrieved(activeConnectionMap) {

                          // Within each data source, count each active connection by identifier
                          angular.forEach(activeConnectionMap,
                              function addActiveConnections(activeConnections,
                                  dataSource) {
