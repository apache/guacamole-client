...
angular.module('settings').factory('ConnectionHistoryEntryWrapper',
    ['$injector',
      function defineConnectionHistoryEntryWrapper($injector) {
         ...
         */
        const ConnectionHistoryEntryWrapper = function ConnectionHistoryEntryWrapper(dataSource,
            historyEntry) {
          ...
          this.sessionRecording = (function getSessionRecording() {
            ...
            var name = _.findKey(historyEntry.logs, log => log.type
            ...
            return new ConnectionHistoryEntryWrapper.Log({
              ...
              description: $translate(log.description.key,
