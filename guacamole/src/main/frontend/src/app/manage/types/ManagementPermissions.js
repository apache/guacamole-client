...
angular.module('manage').factory('ManagementPermissions', ['$injector',
  function defineManagementPermissions($injector) {
    ...
    ManagementPermissions.fromPermissionSet = function fromPermissionSet(
      ...
      var canCreate = PermissionSet.hasSystemPermission(permissions,
          createPermission);
      var canAdminister = hasObjectPermission(permissions,
          PermissionSet.ObjectPermissionType.ADMINISTER, identifier);
      var canUpdate = hasObjectPermission(permissions,
          PermissionSet.ObjectPermissionType.UPDATE, identifier);
      var canDelete = hasObjectPermission(permissions,
