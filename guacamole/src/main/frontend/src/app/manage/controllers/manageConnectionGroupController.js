...
angular.module('manage').controller('manageConnectionGroupController',
    ['$scope', '$injector',
      function manageConnectionGroupController($scope, $injector) {
         ...
         */
        var loadExistingConnectionGroup = function loadExistingConnectionGroup(dataSource,
            identifier) {
         ...
         */
        var loadClonedConnectionGroup = function loadClonedConnectionGroup(dataSource,
            identifier) {
          return connectionGroupService.getConnectionGroup(
              dataSource,
              identifier
        ...
        var loadRequestedConnectionGroup = function loadRequestedConnectionGroup() {
          ...
          if (identifier) {
            return loadExistingConnectionGroup($scope.selectedDataSource,
                identifier);
          }
          ...
          if (cloneSourceIdentifier) {
            return loadClonedConnectionGroup($scope.selectedDataSource,
        ...
        $scope.cloneConnectionGroup = function cloneConnectionGRoup() {
          $location.path(
              ...
              + '/connectionGroups').search('clone', identifier);
        };
        ...
        $scope.saveConnectionGroup = function saveConnectionGroup() {
          return connectionGroupService.saveConnectionGroup(
              $scope.selectedDataSource, $scope.connectionGroup);
        };
