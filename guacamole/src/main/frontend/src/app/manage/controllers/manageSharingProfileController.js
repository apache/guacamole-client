    ...
    ['$scope', '$injector',
      function manageSharingProfileController($scope, $injector) {
        ...
        var loadExistingSharingProfile = function loadExistingSharingProfile(dataSource,
            identifier) {
          return $q.all({
            sharingProfile: sharingProfileService.getSharingProfile(dataSource,
                identifier),
         ...
         */
        var loadClonedSharingProfile = function loadClonedSharingProfile(dataSource,
            identifier) {
          return $q.all({
            sharingProfile: sharingProfileService.getSharingProfile(dataSource,
                identifier),
        ...
        var loadRequestedSharingProfile = function loadRequestedSharingProfile() {
          ...
          if (identifier) {
            return loadExistingSharingProfile($scope.selectedDataSource,
                identifier);
          }

          // If we are cloning an existing sharing profile, pull its data instead
          if (cloneSourceIdentifier) {
            return loadClonedSharingProfile($scope.selectedDataSource,
        ...
        $scope.cloneSharingProfile = function cloneSharingProfile() {
          $location.path(
              ...
              + '/sharingProfiles').search('clone', identifier);
        };
        ...
        $scope.saveSharingProfile = function saveSharingProfile() {
          ...
          return sharingProfileService.saveSharingProfile(
              $scope.selectedDataSource, $scope.sharingProfile);
