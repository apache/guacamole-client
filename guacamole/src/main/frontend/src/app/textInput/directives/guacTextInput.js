...
angular.module('textInput').directive('guacTextInput', [function guacTextInput() {
    ...
    return {
        ...
        controller: ['$scope', '$rootScope', '$element', '$timeout',
            ...
            // Handle paste events separately from other input events.
            target.addEventListener("paste", function targetPaste(e) {
                ...
                // Normalize line endings to \n before replaying as key events.
                content = content.replace(/\r\n/g, '\n').replace(/\r/g, '\n');

                // Release modifiers first to avoid pasted characters being
                // interpreted as Ctrl+char or Alt+char combinations in the
                // remote session.
                ...
                // Prevent the input handler from also processing pasted content.
                // This also prevents additional insertParagraph events from being
                // generated by Chrome.
                e.preventDefault();
                e.stopPropagation();
