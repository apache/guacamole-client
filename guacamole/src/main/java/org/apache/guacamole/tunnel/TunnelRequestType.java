...
public enum TunnelRequestType {
  ...
  /**
   * The parameter value which denotes a destination object of this type within a tunnel request.
   *
   * @see TunnelRequest#TYPE_PARAMETER
   * @see TunnelRequest#getType()
   */
  ...
  /**
   * Defines a tunnel request type having the given corresponding parameter value and human-readable
   * name.
   *
   * @param value The parameter value which denotes a destination object of this type.
   * @param name  A human-readable, descriptive name of the type of destination object.
   */
  ...
  /**
   * Parses the given tunnel request type string, returning the TunnelRequestType which matches that
   * string, as declared by {@link #PARAMETER_VALUE}. If no such type exists, null is returned.
   *
   * @param type The type string to parse.
   * @return The TunnelRequestType which specifies the given string as its {@link #PARAMETER_VALUE},
  ...
  /**
   * Retrieves the object having the given identifier from the given UserContext, where the type of
   * object retrieved is the type of object represented by this tunnel request type.
   *
   * @param userContext The UserContext to retrieve the object from.
   ...
   * @throws GuacamoleException If an error occurs retrieving the requested object, or if permission
