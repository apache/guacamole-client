...
public abstract class GuacamoleWebSocketTunnelServlet extends WebSocketServlet {
  ...
  private static final Logger logger = LoggerFactory.getLogger(
      GuacamoleWebSocketTunnelServlet.class);
  ...
  /**
   * Sends the given numeric Guacamole and WebSocket status on the given WebSocket connection and
  ...
  /**
   * Called whenever the JavaScript Guacamole client makes a connection request. It it up to the
   * implementor of this function to define what conditions must be met for a tunnel to be
   ...
   *
   * @param request The TunnelRequest associated with the connection request received. Any
