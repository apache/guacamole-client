...
public abstract class GuacamoleWebSocketTunnelListener implements WebSocketListener {
  ...
  private static final Logger logger = LoggerFactory.getLogger(
      RestrictedGuacamoleWebSocketTunnelServlet.class);
  ...
  /**
   * Sends the given numeric Guacamole and WebSocket status codes on the given WebSocket connection
   * and closes the connection.
   *
   * @param session             The outbound WebSocket connection to close.
   * @param guacamoleStatusCode The numeric Guacamole status code to send.
