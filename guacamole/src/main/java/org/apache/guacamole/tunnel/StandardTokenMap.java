...
/**
 * Map which is automatically populated with the name/value pairs of all standardized tokens
 * available for a particular AuthenticatedUser.
 */
public class StandardTokenMap extends HashMap<String, String> {
  ...
  /**
   * The name of the token containing the hostname/address of the machine the user authenticated
   * from.
   */
  public static final String CLIENT_HOSTNAME_TOKEN = "GUAC_CLIENT_HOSTNAME";

  /**
   * The name of the token containing the IP address of the machine the user authenticated from.
   */
  ...
  /**
   * Creates a new StandardTokenMap which is pre-populated with the name/value pairs of all
   * standardized tokens available for the given AuthenticatedUser.
   *
   * @param authenticatedUser The AuthenticatedUser to generate standard tokens for.
   */
