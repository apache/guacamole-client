...
/**
 * A REST resource which exposes all data associated with a Guacamole user's session via the
 * underlying UserContexts.
 */
...
public class SessionResource {
  ...
  /**
   * The authentication token associated with the GuacamoleSession being exposed by this
   * SessionResource.
   */
  ...
  /**
   * Factory for creating UserContextResources which expose a given UserContext.
   */
  @Inject
  private UserContextResourceFactory userContextResourceFactory;

  /**
   * Factory for creating instances of resources which represent the collection of tunnels within a
   * GuacamoleSession.
   */
  @Inject
  ...
  /**
   * Creates a new SessionResource which exposes the data within the given GuacamoleSession.
   *
   * @param token   The authentication token associated with the given session.
   * @param session The GuacamoleSession which should be exposed through this SessionResource.
   */
  @AssistedInject
  ...
  /**
   * Retrieves a resource representing the UserContext associated with the AuthenticationProvider
   * having the given identifier.
   *
   * @param authProviderIdentifier The unique identifier of the AuthenticationProvider associated
   *                               with the UserContext being retrieved.
   * @return A resource representing the UserContext associated with the AuthenticationProvider
   * having the given identifier.
  ...
  /**
   * Returns the arbitrary REST resource exposed by the UserContext associated with the
   * AuthenticationProvider having the given identifier.
   *
   * @param authProviderIdentifier The unique identifier of the AuthenticationProvider associated
   *                               with the UserContext whose arbitrary REST service is being
   *                               retrieved.
   * @return The arbitrary REST resource exposed by the UserContext exposed by this
   * UserContextresource.
  ...
  /**
   * Retrieves a resource representing all tunnels associated with session exposed by this
   * SessionResource.
   *
   * @return A resource representing all tunnels associated with the AuthenticationProvider having
  ...
  /**
   * Invalidates the GuacamoleSession exposed by this SessionResource, including the associated
