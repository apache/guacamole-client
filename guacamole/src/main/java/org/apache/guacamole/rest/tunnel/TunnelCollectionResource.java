...
public class TunnelCollectionResource {
  ...
  /**
   * Creates a new TunnelCollectionResource which exposes the active tunnels of the given
   * GuacamoleSession.
   *
   * @param session The GuacamoleSession whose tunnels should be exposed by this resource.
   */
  @AssistedInject
  ...
  /**
   * Returns the UUIDs of all tunnels exposed by this TunnelCollectionResource.
   *
   * @return A set containing the UUIDs of all tunnels exposed by this TunnelCollectionResource.
   */
  @GET
  ...
  /**
   * Retrieves the tunnel having the given UUID, returning a TunnelResource representing that
   * tunnel. If no such tunnel exists, an exception will be thrown.
   *
   * @param tunnelUUID The UUID of the tunnel to return via a TunnelResource.
   * @return A TunnelResource which represents the tunnel having the given UUID.
   * @throws GuacamoleException If no such tunnel exists.
   */
  @Path("{tunnel}")
