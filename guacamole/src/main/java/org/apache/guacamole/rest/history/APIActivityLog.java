...
public class APIActivityLog {
  ...
  /**
   * Creates a new APIActivityLog, copying the data from the given activity log.
   *
   * @param log The log to copy data from.
   */
   ...
   * should be interpreted or exposed, however the content of a log is not directly exposed by this
   * class.
   *
