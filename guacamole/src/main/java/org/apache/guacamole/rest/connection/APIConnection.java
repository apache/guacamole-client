...
public class APIConnection {
  ...
  /**
   * All associated sharing profiles. If sharing profiles are not being queried, this may be
   * omitted.
   */
   ...
   * used or this information is unavailable.
   */
  ...
  /**
   * Create an APIConnection from a Connection record. Parameters for the connection will not be
   * included.
   *
   * @param connection The connection to create this APIConnection from.
   * @throws GuacamoleException If a problem is encountered while instantiating this new
   *                            APIConnection.
   */
   ...
   *
   * @param parentIdentifier The parent connection group identifier for this connection.
   */
   ...
   *
   * @return The number of currently active usages of this connection.
   */
   ...
   *
   * @param activeConnections The number of currently active usages of this connection.
   */
  ...
  /**
   * Returns a map of all attributes associated with this connection. Each entry key is the
   * attribute identifier, while each value is the attribute value itself.
   *
   * @return The attribute map for this connection.
   */
  ...
  /**
   * Sets the map of all attributes associated with this connection. Each entry key is the attribute
   * identifier, while each value is the attribute value itself.
   *
   * @param attributes The attribute map for this connection.
   */
  ...
  /**
   * Returns a collection of all associated sharing profiles, or null if sharing profiles have not
   * been queried.
   *
   * @return A collection of all associated sharing profiles, or null if sharing profiles have not
   * been queried.
   */
  ...
  /**
   * Sets the collection of all associated sharing profiles to the given collection, which may be
   * null if sharing profiles have not been queried.
   *
   * @param sharingProfiles The collection containing all sharing profiles associated with this
   ...
   * never been used or this information is unavailable.
   *
