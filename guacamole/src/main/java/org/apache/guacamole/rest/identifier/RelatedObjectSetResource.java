...
/**
 * A REST resource which abstracts the operations available on arbitrary sets of objects which share
...
public class RelatedObjectSetResource {
  ...
  /**
   * The path of any operation within a JSON patch which adds/removes an object from the associated
   * set.
   */
  ...
  /**
   * Creates a new RelatedObjectSetResource which exposes the operations and subresources available
   * for the given RelatedObjectSet.
   *
   * @param objects The RelatedObjectSet exposed by this RelatedObjectSetResource.
   */
  ...
  /**
   * Returns the identifiers of all objects within RelatedObjectSet exposed by this
   * RelatedObjectSetResource.
   *
   * @return The identifiers of all objects within RelatedObjectSet exposed by this
   * RelatedObjectSetResource.
   * @throws GuacamoleException If an error occurs while retrieving the objects within the set, or
  ...
  /**
   * Updates the given RelatedObjectSetPatch by queuing an add or remove operation for the object
   * having the given identifier based on the given patch operation.
   *
   * @param operation             The patch operation to perform.
   * @param relatedObjectSetPatch The RelatedObjectSetPatch being modified.
   * @param identifier            The identifier of the object being added or removed from the set.
   ...
   * RelatedObjectSetResource. Each patch specifies either an "add" or a "remove" operation for a
   * particular object represented by its identifier. The path of each operation MUST be "/", with
   * the identifier of the object being provided within the value of the patch.
   *
   * @param patches The patches to apply for this request.
   * @throws GuacamoleException If an error is encountered while modifying the contents of the
   *                            RelatedObjectSet.
   */
  @PATCH
