 ...
 * org.apache.guacamole.net.auth.UserGroup is required. As a simple wrapper for APIUserGroup, access
 * to permissions, groups, and members is not provided. Any attempt to access or manipulate
 * permissions or group membership via an APIUserGroupWrapper will result in an exception.
 */
public class APIUserGroupWrapper implements UserGroup {
  ...
  /**
   * Creates a new APIUserGroupWrapper which wraps the given APIUserGroup, exposing its properties
   * through the UserGroup interface.
   *
   * @param apiUserGroup The APIUserGroup to wrap.
   */
  ...
  public SystemPermissionSet getSystemPermissions()
    ...
    throw new GuacamoleUnsupportedException(
        "APIUserGroupWrapper does not provide permission access.");
  }
