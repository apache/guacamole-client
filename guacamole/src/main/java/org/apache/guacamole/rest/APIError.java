...
public class APIError {
  ...
  /**
   * The translation key of the generic translation string which should be used to display arbitrary
   * messages which otherwise have no translation string.
   */
  ...
  /**
   * Creates a new APIError which exposes the details of the given GuacamoleException. If the given
   * GuacamoleException implements Translatable, then its translation string and values will be
   * exposed as well.
   *
   * @param exception The GuacamoleException from which the details of the new APIError should be
   *                  derived.
   */
  ...
  /**
   * Returns the Guacamole protocol status code associated with the error that occurred. This is
   * only valid for errors of type STREAM_ERROR.
   *
   * @return The Guacamole protocol status code associated with the error that occurred. If the
   * error is not of type STREAM_ERROR, this will be null.
   */
  ...
  /**
   * Returns a translatable message describing the error that occurred. If no translatable message
   * is associated with the error, this will be null.
   *
   * @return A translatable message describing the error that occurred, or null if there is no such
   * message defined.
   */
  ...
  public enum Type {
    ...
    /**
     * The requested operation could not be performed because the request itself was malformed.
     */
    BAD_REQUEST,
    ...
    /**
     * The credentials provided were not necessarily invalid, but were not sufficient to determine
     * validity.
     */
    ...
    /**
     * An error occurred within an intercepted stream, terminating that stream. The Guacamole
     * protocol status code of that error can be retrieved with getStatusCode().
     */
    STREAM_ERROR;

    /**
     * Returns the REST API error type which corresponds to the type of the given exception.
     *
     * @param exception The exception to use to derive the API error type.
     * @return The API error type which corresponds to the type of the given exception.
     */
