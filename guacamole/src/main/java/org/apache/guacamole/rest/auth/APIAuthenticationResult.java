...
/**
 * A simple object which describes the result of an authentication operation, including the
 * resulting token.
 */
public class APIAuthenticationResult {
   ...
   *
   * @param authToken            The unique token generated for the user that authenticated, to be
   *                             used for the duration of their session.
   * @param username             The username of the user owning the given token.
   * @param dataSource           The unique identifier of the AuthenticationProvider which
   *                             authenticated the user.
   * @param availableDataSources The unique identifier of all AuthenticationProviders to which the
   *                             user now has access.
   */
  ...
  /**
   * Returns the identifiers of all data sources available to the user associated with the current
   * session.
   *
   * @return The identifiers of all data sources available to the user associated with the current
   * session.
   */
