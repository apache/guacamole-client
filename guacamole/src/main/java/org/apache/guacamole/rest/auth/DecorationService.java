...
/**
 * A service for applying or reapplying layers of decoration to UserContexts. The semantics of
 * UserContext decoration/redecoration is defined by the AuthenticationProvider interface.
 */
public class DecorationService {
  ...
  /**
   * Creates a new DecoratedUserContext, invoking the decorate() function of all
   * AuthenticationProviders to decorate the provided UserContext. Decoration by each
   * AuthenticationProvider will occur in the order that the AuthenticationProviders were loaded.
   ...
   *                          UserContext.
   * @return A new DecoratedUserContext which has been decorated by all AuthenticationProviders.
   * @throws GuacamoleException If any AuthenticationProvider fails while decorating the
   *                            UserContext.
   */
  ...
  /**
   * Creates a new DecoratedUserContext, invoking the redecorate() function of all
   * AuthenticationProviders to reapply decoration. Decoration by each AuthenticationProvider will
   * occur in the order that the AuthenticationProviders were loaded. Only AuthenticationProviders
