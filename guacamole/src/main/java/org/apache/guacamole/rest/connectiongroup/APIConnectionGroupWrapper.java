...
/**
 * A wrapper to make an APIConnection look like a ConnectionGroup. Useful where a
 * org.apache.guacamole.net.auth.ConnectionGroup is required.
 */
public class APIConnectionGroupWrapper implements ConnectionGroup {
  ...
  /**
   * Create a new APIConnectionGroupWrapper to wrap the given APIConnectionGroup as a
   * ConnectionGroup.
   *
