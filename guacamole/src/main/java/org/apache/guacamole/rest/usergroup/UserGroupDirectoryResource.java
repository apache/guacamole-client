...
/**
 * A REST resource which abstracts the operations available on a Directory of UserGroups.
 */
...
public class UserGroupDirectoryResource extends DirectoryResource<UserGroup, APIUserGroup> {
  ...
  /**
   * Creates a new UserGroupDirectoryResource which exposes the operations and subresources
   * available for the given UserGroup Directory.
   *
   * @param userContext     The UserContext associated with the given Directory.
   * @param directory       The Directory being exposed.
   * @param translator      A DirectoryObjectTranslator implementation which handles UserGroups.
