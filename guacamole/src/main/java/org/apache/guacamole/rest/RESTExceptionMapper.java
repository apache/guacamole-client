...
/**
 * A class that maps GuacamoleExceptions in a way that returns a custom response to the user via
 * JSON rather than allowing the default web application error handling to take place.
 */
@Provider
@Singleton
public class RESTExceptionMapper implements ExceptionMapper<Throwable> {
  ...
  /**
   * The ContainerRequest representing the HTTP request that resulted in the Throwable being
   * intercepted. Despite this class being a Singleton, this object will always be scoped with the
