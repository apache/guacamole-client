...
/**
 * A REST resource which abstracts the operations available on a Directory of Users.
 */
...
public class UserDirectoryResource extends DirectoryResource<User, APIUser> {
  ...
  /**
   * Creates a new UserDirectoryResource which exposes the operations and subresources available for
