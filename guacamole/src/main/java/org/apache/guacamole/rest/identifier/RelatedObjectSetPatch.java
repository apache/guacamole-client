...
/**
 * A set of changes to be applied to a RelatedObjectSet, describing the objects being added and/or
 * removed.
 */
public class RelatedObjectSetPatch {
  ...
  /**
   * Queues the object having the given identifier for addition to the underlying RelatedObjectSet.
   * The add operation will be performed only when apply() is called.
   *
  ...
  /**
   * Queues the object having the given identifier for removal from the underlying RelatedObjectSet.
   * The remove operation will be performed only when apply() is called.
   *
   ...
   *
   * @param objects The RelatedObjectSet to add and/or remove objects from.
   * @throws GuacamoleException If any add or remove operation is disallowed by the underlying
   *                            RelatedObjectSet.
   */
