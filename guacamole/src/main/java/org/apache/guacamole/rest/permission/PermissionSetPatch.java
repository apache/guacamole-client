...
/**
 * A set of changes to be applied to a PermissionSet, describing the set of permissions being added
 * and removed.
 *
 * @param <PermissionType> The type of permissions being added and removed.
 */
public class PermissionSetPatch<PermissionType extends Permission> {
  ...
  /**
   * Queues the given permission to be added. The add operation will be performed only when apply()
   * is called.
   *
  ...
  /**
   * Queues the given permission to be removed. The remove operation will be performed only when
   * apply() is called.
   *
   ...
   *
   * @param permissionSet The permission set to add and remove permissions from.
   * @throws GuacamoleException If an error occurs while manipulating the permissions of the given
   *                            permission set.
   */
