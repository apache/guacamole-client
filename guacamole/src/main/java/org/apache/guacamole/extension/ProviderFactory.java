...
/**
 * A utility for creating provider instances and logging unexpected outcomes with sufficient detail
 * to allow debugging.
 */
class ProviderFactory {
   ...
   *
   * @param typeName      The provider type name used for log messages; e.g. "authentication
   *                      provider".
