...
public class DirectoryClassLoader extends URLClassLoader {
   ...
   *
   * @param dir The directory from which .jar files should be read.
   * @throws GuacamoleException If the given file is not a directory, or the contents of the given
  ...
  /**
   * Returns an instance of DirectoryClassLoader configured to load .jar files from the given
   * directory. Calling this function multiple times will not affect previously-returned instances
   * of DirectoryClassLoader.
   *
   * @param dir The directory from which .jar files should be read.
   * @return A DirectoryClassLoader instance which loads classes from the .jar files in the given
   * directory.
   * @throws GuacamoleException If the given file is not a directory, or the contents of the given
   *                            directory cannot be read.
   */
   ...
   *
   * @param dir The directory to retrieve all .jar files from.
   * @return An array of the URLs of all .jar files within the given directory.
   * @throws GuacamoleException If the given file is not a directory, or the contents of the given
   *                            directory cannot be read.
   */
