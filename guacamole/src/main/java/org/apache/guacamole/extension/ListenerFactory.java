...
/**
 * A factory that reflectively instantiates Listener objects for a given provider class.
 */
class ListenerFactory {
   ...
   * <p>
   * If a provider class implements the simple Listener interface, that is the only listener type
   * that will be returned. Otherwise, a list of Listener objects that adapt the legacy listener
   * interfaces will be returned.
   *
   * @param providerClass A class that represents a listener.
   * @return The list of listeners represented by the given provider class.
   */
  ...
  /**
   * Creates a list of adapters for the given object, based on the legacy listener interfaces it
   * implements.
   *
   * @param provider An object that implements zero or more legacy listener interfaces.
   * @return The list of listeners represented by the given provider class.
   */
  ...
  /**
   * An adapter the allows an AuthenticationSuccessListener to be used as an ordinary Listener.
   */
  @SuppressWarnings("deprecation")
  private static class AuthenticationSuccessListenerAdapter implements Listener {
    ...
    /**
     * Handles an AuthenticationSuccessEvent by passing the event to the delegate listener. If the
     * delegate returns false, the adapter throws a GuacamoleException to veto the authentication
     * success event. All other event types are ignored.
     *
     * @param event An object that describes the event that occurred.
     * @throws GuacamoleException If thrown by the delegate listener.
     */
    @Override
  ...
  /**
   * An adapter the allows an AuthenticationFailureListener to be used as an ordinary Listener.
   */
  @SuppressWarnings("deprecation")
  private static class AuthenticationFailureListenerAdapter implements Listener {
    ...
    /**
     * Handles an AuthenticationFailureEvent by passing the event to the delegate listener. All
  ...
  /**
   * An adapter the allows a TunnelConnectListener to be used as an ordinary Listener.
   */
  @SuppressWarnings("deprecation")
  private static class TunnelConnectListenerAdapter implements Listener {
    ...
    /**
     * Handles a TunnelConnectEvent by passing the event to the delegate listener. If the delegate
     * returns false, the adapter throws a GuacamoleException to veto the tunnel connect event. All
     * other event types are ignored.
     *
     * @param event An object that describes the event that occurred.
     * @throws GuacamoleException If thrown by the delegate listener.
  ...
  /**
   * An adapter the allows a TunnelCloseListener to be used as an ordinary Listener.
   */
  @SuppressWarnings("deprecation")
  private static class TunnelCloseListenerAdapter implements Listener {
    ...
    /**
     * Handles a TunnelCloseEvent by passing the event to the delegate listener. If the delegate
     * returns false, the adapter throws a GuacamoleException to veto the tunnel connect event. All
     * other event types are ignored.
     *
     * @param event An object that describes the event that occurred.
