...
/**
 * Mapping of username/password pair to configuration set. In addition to basic storage of the
 * username, password, and configurations, this class also provides password validation functions.
 */
public class Authorization {
  ...
  /**
   * The password corresponding to the username being authorized, which may be hashed.
   */
  ...
  /**
   * Sets the password associated with this authorization, which must be encoded using the encoding
   * specified with setEncoding(). By default, passwords are plain text.
   *
  ...
  /**
   * Sets the encoding which will be used to hash the password or when comparing a given password
   * for validation.
   *
  ...
  /**
   * Returns whether a given username/password pair is authorized based on the stored username and
   * password. The password given must be plain text. It will be hashed as necessary to perform the
   * validation.
   *
   * @param username The username to validate.
   * @param password The password to validate.
   * @return true if the username/password pair given is authorized, false otherwise.
   */
  ...
  /**
   * Returns the GuacamoleConfiguration having the given name and associated with the
   * username/password pair stored within this authorization.
   *
   * @param name The name of the GuacamoleConfiguration to return.
   * @return The GuacamoleConfiguration having the given name, or null if no such
   * GuacamoleConfiguration exists.
   */
  ...
  /**
   * Adds the given GuacamoleConfiguration to the set of stored configurations under the given
   * name.
   *
  ...
  /**
   * Returns a Map of all stored GuacamoleConfigurations associated with the username/password pair
   * stored within this authorization, indexed by configuration name.
   *
