...
/**
 * Servlet which serves a given resource for all HTTP GET requests. The HEAD method is correctly
 * supported, and HTTP 304 ("Not Modified") responses will be properly returned for GET requests
 * depending on the last time the resource was modified.
 */
public class ResourceServlet extends HttpServlet {
  ...
  /**
   * The size of the buffer to use when transferring data from the input stream of a resource to the
   * output stream of a request.
   */
