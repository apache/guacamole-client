...
/**
 * A GuacamoleProperty whose value is a Set of unique Strings. The string value parsed to produce
 * this set is a comma-delimited list. Duplicate values are ignored, as is any whitespace following
