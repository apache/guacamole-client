...
public class TokenNameTest {
  ...
  /**
   * Verifies that TokenName.canonicalize() generates token names as specified, regardless of the
  ...
  public void testCanonicalize() {
    ...
    assertEquals("CAMEL_CASE", TokenName.canonicalize("CamelCase"));
    assertEquals("LOWERCASE_WITH_UNDERSCORES",
        TokenName.canonicalize("lowercase_with_underscores"));
    assertEquals("UPPERCASE_WITH_UNDERSCORES",
        TokenName.canonicalize("UPPERCASE_WITH_UNDERSCORES"));
    assertEquals("A_VERY_INCONSISTENT_MIX_OF_ALL_STYLES",
        TokenName.canonicalize("aVery-INCONSISTENTMix_ofAllStyles"));
