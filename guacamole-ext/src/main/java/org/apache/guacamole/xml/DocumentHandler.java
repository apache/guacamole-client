...
/**
 * A simple ContentHandler implementation which digests SAX document events and produces simpler
 * tag-level events, maintaining its own stack for the convenience of the tag handlers.
 */
public class DocumentHandler extends DefaultHandler {
  ...
  /**
   * The handler which will be used to handle element events for the root element of the document.
   */
  private TagHandler root;

  /**
   * The stack of all states applicable to the current parser state. Each element of the stack
   * references the TagHandler for the element being parsed at that level of the document, where the
   * current element is last in the stack, and the root element is first.
   */
   ...
   *
   * @param rootElementName The name of the root element of the document being handled.
  ...
  /**
   * Returns the current element state. The current element state is the state of the element the
   * parser is currently within.
   *
  ...
  private static class DocumentHandlerState {
    ...
    /**
     * The TagHandler which must handle document events related to the element currently being
     * parsed.
     */
    private TagHandler tagHandler;

    /**
     * Creates a new DocumentHandlerState which will maintain the state of parsing of the current
     * element, as well as contain the TagHandler which will receive events related to that
     * element.
     *
     * @param tagHandler The TagHandler which should receive any events related to the element being
     *                   parsed.
     */
    ...
    /**
     * Returns the mutable StringBuilder which contains the current text content of the element
     * being parsed.
     *
     * @return The mutable StringBuilder which contains the current text content of the element
     * being parsed.
     */
    ...
    /**
     * Returns the TagHandler which must handle any events relating to the element being parsed.
     *
     * @return The TagHandler which must handle any events relating to the element being parsed.
     */
