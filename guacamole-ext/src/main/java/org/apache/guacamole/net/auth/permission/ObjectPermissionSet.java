...
/**
 * A set of permissions which affect arbitrary objects, where each object has an associated unique
 * identifier.
 */
public interface ObjectPermissionSet extends PermissionSet<ObjectPermission> {
  ...
  /**
   * Tests whether the permission of the given type is granted for the object having the given
   * identifier.
   *
   * @param permission The permission to check.
   * @param identifier The identifier of the object affected by the permission being checked.
   ...
   * @param identifier The identifier of the object affected by the permission being added.
  ...
  /**
   * Tests whether this user has the specified permissions for the objects having the given
   * identifiers. The identifier of an object is returned in a new collection if at least one of the
   * specified permissions is granted for that object.
   *
   * @param permissions The permissions to check. An identifier will be included in the resulting
   *                    collection if at least one of these permissions is granted for the
   *                    associated object
   * @param identifiers The identifiers of the objects affected by the permissions being checked.
