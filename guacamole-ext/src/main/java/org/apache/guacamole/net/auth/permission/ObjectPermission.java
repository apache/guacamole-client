...
public class ObjectPermission implements Permission<ObjectPermission.Type> {
  ...
  /**
   * The identifier of the GuacamoleConfiguration associated with the operation affected by this
   * permission.
   */
  ...
  /**
   * Creates a new ObjectPermission having the given type and identifier. The identifier must be the
   * unique identifier assigned to the object associated with this permission by the
   * AuthenticationProvider in use.
   *
   * @param type       The type of operation affected by this permission.
   * @param identifier The identifier of the object associated with the operation affected by this
   *                   permission.
   */
   ...
   *
   * @return The identifier of the specific object affected by this permission.
   */
  ...
  public int hashCode() {
    int hash = 5;
    if (identifier != null) {
      hash = 47 * hash + identifier.hashCode();
    }
    if (type != null) {
      hash = 47 * hash + type.hashCode();
    }
    return hash;
  }
  ...
  /**
   * Specific types of object-level permissions. Each permission type is related to a specific class
   * of object-level operation.
   */
  public enum Type {
