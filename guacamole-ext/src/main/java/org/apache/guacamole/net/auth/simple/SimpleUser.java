...
/**
 * A read-only User implementation which has no permissions. Implementations that need to define
 * permissions should extend this class and override the associated getters.
 */
public class SimpleUser extends AbstractUser {
  ...
  /**
   * Creates a new SimpleUser having the given username and READ access to the connections and
   * connection groups having the given identifiers.
   *
   * @param username                   The username to assign to this SimpleUser.
   * @param connectionIdentifiers      The identifiers of all connections this user has READ access
   *                                   to.
   * @param connectionGroupIdentifiers The identifiers of all connection groups this user has READ
   *                                   access to.
   * @deprecated Extend and override the applicable permission set getters instead, relying on
   * SimpleUser to expose no permissions by default for all permission sets that aren't overridden.
   * See {@link SimpleObjectPermissionSet} for convenient methods of providing a read-only
   * permission set with specific permissions.
   */
  @Deprecated
  public SimpleUser(String username,
  ...
  /**
   * Creates a new SimpleUser having the given username and READ access to the users, connections,
   * and groups having the given identifiers.
   *
   * @param username                   The username to assign to this SimpleUser.
   * @param userIdentifiers            The identifiers of all users this user has READ access to.
   * @param connectionIdentifiers      The identifiers of all connections this user has READ access
   *                                   to.
   * @param connectionGroupIdentifiers The identifiers of all connection groups this user has READ
   *                                   access to.
   ...
   *
   * @param permissions The set of permissions to add READ permissions to.
   * @param identifiers The identifiers which should each have a corresponding READ permission added
   *                    to the given set.
   */
