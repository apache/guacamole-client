...
public class DelegatingConnection implements Connection {
   ...
   * still resulting in the same behavior as older versions of DelegatingConnection. <strong>This
  ...
  /**
   * Wraps the given Connection such that all function calls against this DelegatingConnection will
   * be delegated to it.
   *
   ...
   *
   * @return The Connection wrapped by this DelegatingConnection.
   */
