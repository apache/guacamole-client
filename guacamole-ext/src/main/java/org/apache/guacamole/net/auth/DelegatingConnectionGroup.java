...
/**
 * ConnectionGroup implementation which simply delegates all function calls to an underlying
 * ConnectionGroup.
 */
public class DelegatingConnectionGroup implements ConnectionGroup {
   ...
   * still resulting in the same behavior as older versions of DelegatingConnectionGroup.
   * <strong>This storage should be removed once support for the old, deprecated connect() is
   * removed.</strong>
   */
   ...
   *
   * @return The ConnectionGroup wrapped by this DelegatingConnectionGroup.
   */
