...
/**
 * An extremely simple read-only implementation of a Directory of GuacamoleConfigurations which
 * provides access to a pre-defined Map of GuacamoleConfigurations.
 *
...
public class SimpleConnectionDirectory extends SimpleDirectory<Connection> {
  ...
  /**
   * Creates a new SimpleConnectionDirectory which provides access to the connections contained
   * within the given Map.
   *
   * @param connections A Collection of all connections that should be present in this connection
   *                    directory.
   */
  ...
  /**
   * An internal method for modifying the Connections in this Directory. Returns the previous
   * connection for the given identifier, if found.
   *
