...
/**
 * UserContext implementation which simply delegates all function calls to an underlying
 * UserContext.
 */
public class DelegatingUserContext implements UserContext {
  ...
  /**
   * Wraps the given UserContext such that all function calls against this DelegatingUserContext
   ...
   *
   * @return The UserContext wrapped by this DelegatingUserContext.
   */
