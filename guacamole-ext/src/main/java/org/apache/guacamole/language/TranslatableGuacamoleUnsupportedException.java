...
/**
 * A {@link GuacamoleUnsupportedException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleUnsupportedException extends
    GuacamoleUnsupportedException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleUnsupportedException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleUnsupportedException with the given message. The message
