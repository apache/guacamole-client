...
/**
 * A {@link GuacamoleClientOverrunException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleClientOverrunException extends
    GuacamoleClientOverrunException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleClientOverrunException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleClientOverrunException with the given message. The message
