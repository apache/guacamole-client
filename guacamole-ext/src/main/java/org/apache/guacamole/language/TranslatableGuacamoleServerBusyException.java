...
/**
 * A {@link GuacamoleServerBusyException} whose associated message is translatable and can be passed
 * through an arbitrary translation service, producing a human-readable message in the user's native
 * language.
 */
public class TranslatableGuacamoleServerBusyException extends
    GuacamoleServerBusyException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleServerBusyException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleServerBusyException with the given message. The message must
   * be provided in both non-translatable (readable as-written) and translatable forms.
   *
   * @param message             A human-readable description of the exception that occurred. This
   *                            message should be readable on its own and as-written, without
   *                            requiring a translation service.
