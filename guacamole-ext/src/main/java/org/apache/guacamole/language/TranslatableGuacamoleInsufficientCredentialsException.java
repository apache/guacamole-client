...
/**
 * A {@link GuacamoleInsufficientCredentialsException} whose associated message is translatable and
 * can be passed through an arbitrary translation service, producing a human-readable message in the
...
public class TranslatableGuacamoleInsufficientCredentialsException
  ...
  /**
   * Creates a new TranslatableGuacamoleInsufficientCredentialsException with the given message,
   * cause, and associated credential information. The message must be provided in both
  ...
  /**
   * Creates a new TranslatableGuacamoleInsufficientCredentialsException with the given message, and
