...
/**
 * A {@link GuacamoleSessionTimeoutException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleSessionTimeoutException extends
    GuacamoleSessionTimeoutException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleSessionTimeoutException with the given message. The message
