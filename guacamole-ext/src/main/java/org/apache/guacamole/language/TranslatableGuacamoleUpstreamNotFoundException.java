...
/**
 * A {@link GuacamoleUpstreamNotFoundException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleUpstreamNotFoundException extends
    GuacamoleUpstreamNotFoundException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleUpstreamNotFoundException with the given message. The
