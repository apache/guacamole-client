...
/**
 * A {@link GuacamoleSessionConflictException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleSessionConflictException extends
    GuacamoleSessionConflictException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleSessionConflictException with the given message. The message
