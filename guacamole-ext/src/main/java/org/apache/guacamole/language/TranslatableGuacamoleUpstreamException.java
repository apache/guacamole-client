...
/**
 * A {@link GuacamoleUpstreamException} whose associated message is translatable and can be passed
 * through an arbitrary translation service, producing a human-readable message in the user's native
 * language.
 */
public class TranslatableGuacamoleUpstreamException extends GuacamoleUpstreamException implements
    Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleUpstreamException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleUpstreamException with the given message. The message must
