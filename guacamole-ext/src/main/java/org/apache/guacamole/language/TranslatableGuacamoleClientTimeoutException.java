...
/**
 * A {@link GuacamoleClientTimeoutException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleClientTimeoutException extends
    GuacamoleClientTimeoutException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleClientTimeoutException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleClientTimeoutException with the given message. The message
