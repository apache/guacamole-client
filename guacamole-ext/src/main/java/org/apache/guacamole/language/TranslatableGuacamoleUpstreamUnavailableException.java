...
/**
 * A {@link GuacamoleUpstreamUnavailableException} whose associated message is translatable and can
 * be passed through an arbitrary translation service, producing a human-readable message in the
 * user's native language.
 */
public class TranslatableGuacamoleUpstreamUnavailableException extends
    GuacamoleUpstreamUnavailableException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleUpstreamUnavailableException with the given message and
   * cause. The message must be provided in both non-translatable (readable as-written) and
   * translatable forms.
   *
  ...
  /**
   * Creates a new TranslatableGuacamoleUpstreamUnavailableException with the given message. The
