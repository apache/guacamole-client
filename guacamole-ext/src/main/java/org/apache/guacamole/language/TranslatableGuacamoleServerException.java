...
/**
 * A {@link GuacamoleServerException} whose associated message is translatable and can be passed
 * through an arbitrary translation service, producing a human-readable message in the user's native
 * language.
 */
public class TranslatableGuacamoleServerException extends GuacamoleServerException implements
    Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleServerException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleServerException with the given message. The message must be
