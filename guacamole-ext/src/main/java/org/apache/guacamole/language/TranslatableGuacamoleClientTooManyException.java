...
/**
 * A {@link GuacamoleClientTooManyException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleClientTooManyException extends
    GuacamoleClientTooManyException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleClientTooManyException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleClientTooManyException with the given message. The message
