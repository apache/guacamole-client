...
/**
 * A {@link GuacamoleSecurityException} whose associated message is translatable and can be passed
 * through an arbitrary translation service, producing a human-readable message in the user's native
 * language.
 */
public class TranslatableGuacamoleSecurityException extends GuacamoleSecurityException implements
    Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleSecurityException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleSecurityException with the given message. The message must
