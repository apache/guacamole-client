...
/**
 * A {@link GuacamoleClientBadTypeException} whose associated message is translatable and can be
 * passed through an arbitrary translation service, producing a human-readable message in the user's
 * native language.
 */
public class TranslatableGuacamoleClientBadTypeException extends
    GuacamoleClientBadTypeException implements Translatable {
  ...
  /**
   * Creates a new TranslatableGuacamoleClientBadTypeException with the given message and cause. The
  ...
  /**
   * Creates a new TranslatableGuacamoleClientBadTypeException with the given message. The message
