...
/**
 * A {@link GuacamoleCredentialsException} whose associated message is translatable and can be
...
public class TranslatableGuacamoleCredentialsException
  ...
  /**
   * Creates a new TranslatableGuacamoleCredentialsException with the given message, cause, and
  ...
  /**
   * Creates a new TranslatableGuacamoleCredentialsException with the given message, and associated
   * credential information. The message must be provided in both non-translatable (readable
