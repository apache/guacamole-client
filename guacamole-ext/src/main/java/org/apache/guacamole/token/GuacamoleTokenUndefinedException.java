 ...
 * Additional information describing the undefined token is provided.
 */
public class GuacamoleTokenUndefinedException extends GuacamoleServerException {
  ...
  /**
   * Creates a new GuacamoleTokenUndefinedException with the given message, cause, and associated
   * undefined token name.
   *
   * @param message   A human readable description of the exception that occurred.
   * @param cause     The cause of this exception.
   * @param tokenName The name of the token which has no defined value.
   */
  ...
  /**
   * Creates a new GuacamoleTokenUndefinedException with the given message and associated undefined
   * token name.
   *
   * @param message   A human readable description of the exception that occurred.
   * @param tokenName The name of the token which has no defined value.
  ...
  /**
   * Creates a new GuacamoleTokenUndefinedException with the given cause and associated undefined
   * token name.
   *
   * @param cause     The cause of this exception.
   * @param tokenName The name of the token which has no defined value.
   ...
   *
   * @return The name of the token which has no defined value.
   */
